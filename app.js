(() => {
  ...
  const FORMER_CONSTELLATIONS = [{"name":"Anguilla","meaning":"Eel","date":"1754","creator":"John Hill","position":"between Equuleus, Delphinus, Aquila and Serpens","wiki":"","note":"John Hill's 1754 proposal included an eel, spider, toad, shellfish, seahorse, leech, slug, earthworm, pangolin, limpet, mussel, beetle, tortoise and stargazer fish. None of these constellations survived."},{"name":"Anser Americanus","meaning":"American Goose","date":"1627","creator":"Johannes Kepler","position":"Alternative name for Tucana","wiki":""},{"name":"Antinous","meaning":"Antinous","date":"132","creator":"Emperor Hadrian","position":"Southern Aquila","wiki":"https://en.wikipedia.org/wiki/Antinous_(constellation)","note":"This was not an invented monster but Hadrian's real companion. Antinous drowned in the Nile in AD 130; after his death he was deified and a figure of Antinous was placed beneath Aquila. The image remained familiar on European star maps for centuries before its stars were finally absorbed into Aquila. In 2024 the IAU gave θ Aquilae A the official name Antinous, returning the lost figure to the modern sky in miniature.","source":"https://en.wikipedia.org/wiki/Antinous_(constellation)","paragraphs":["Antinous was a historical figure, a young man from Bithynia and the favourite companion of the Roman emperor Hadrian. He drowned in the Nile in AD 130. Hadrian had him deified, founded the city of Antinoöpolis near the place of his death, and promoted a cult that spread across the Roman world.","The celestial Antinous occupied a group of stars immediately south of Aquila. He was commonly shown beneath or in the grasp of the Eagle, and the figure remained on European star maps for many centuries. The constellation formed part of the wider commemoration of Antinous that followed his death.","In 2024 the IAU Working Group on Star Names approved Antinous as the proper name of θ Aquilae A. One star in the former figure now carries the name of both the lost constellation and Hadrian's deified companion."],"images":[{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/Sidney%20Hall%20-%20Urania%27s%20Mirror%20-%20Delphinus%2C%20Sagitta%2C%20Aquila%2C%20and%20Antinous.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:Sidney_Hall_-_Urania's_Mirror_-_Delphinus,_Sagitta,_Aquila,_and_Antinous.jpg","alt":"Urania's Mirror: Aquila and Antinous","caption":""},{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/Marble%20Bust%20of%20Antinous%2C%20from%20Rome%2C%20AD%20130-140%2C%20British%20Museum%20%2814268364836%29.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:Marble_Bust_of_Antinous,_from_Rome,_AD_130-140,_British_Museum_(14268364836).jpg","alt":"Roman marble portrait of Antinous, AD 130–140","caption":"Antinous — Roman marble portrait, AD 130–140"}]},{"name":"Apes","meaning":"Bees (renamed to Vespa, then Lilium, then to Musca Borealis)","date":"1612","creator":"Petrus Plancius","position":"between Perseus and Aries","wiki":"","note":"The figure was repeatedly renamed: Apes, the Bees, became Vespa, then Lilium, and finally Musca Borealis."},{"name":"Apis","meaning":"Bee (obsolete name and renamed to Musca Australis, and then shortened to Musca)","date":"1598","creator":"Petrus Plancius","position":"where Musca is now","wiki":"https://en.wikipedia.org/wiki/Apis_(constellation)"},{"name":"Aranea","meaning":"Long-Legged Spider","date":"1754","creator":"John Hill","position":"between Virgo and Corvus","wiki":""},{"name":"Argo Navis","meaning":"The Ship Argo (now divided into Carina, Puppis, and Vela)","date":"2nd century","creator":"Claudius Ptolemy","position":"where Carina, Puppis and Vela reside now","wiki":"https://en.wikipedia.org/wiki/Argo_Navis","note":"The Argo was the ship of Jason and the Argonauts, and one of Ptolemy's ancient 48 constellations. It occupied such an enormous stretch of the southern sky that later astronomers broke it apart: its keel became Carina, its stern Puppis and its sails Vela. The old ship never vanished cleanly—its Bayer-letter sequence still runs across the descendant constellations rather than restarting neatly in each one.","source":"https://en.wikipedia.org/wiki/Argo_Navis","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Argo%20Navis%20-%20Mercator.jpeg?width=900","imagePage":"https://commons.wikimedia.org/wiki/File:Argo_Navis_-_Mercator.jpeg","imageAlt":"Argo Navis on Mercator's 1551 celestial globe","paragraphs":["Argo Navis represented the ship of Jason and the Argonauts, who sailed to Colchis in search of the Golden Fleece. Jason's uncle Pelias had seized the throne of Iolcus and sent him on an expedition intended to be impossible. Later authors made the crew a gathering of Greek heroes, including Heracles, Orpheus, Castor and Polydeuces.","According to the mythological tradition, Argus built the Argo under Athena's guidance. One account gave its prow a piece of sacred oak from the oracle of Zeus at Dodona, capable of speech or prophecy. At Colchis, Jason succeeded largely through Medea, daughter of King Aeëtes, who used magic to help him yoke the fire-breathing bulls, overcome the warriors sprung from dragon's teeth, and obtain the Fleece before fleeing with him.","Argo Navis was also one of the largest ancient constellations. Ptolemy included it among his 48 constellations, and later atlases drew the great ship along the southern Milky Way. Its stars represented parts of the vessel, including the keel, stern and sails.","The division of Argo Navis is still reflected in modern Bayer designations. Its principal regions became Carina, Puppis and Vela, but the Greek-letter sequence was not restarted in each new constellation. Alpha and Beta remained in Carina, for example, while other letters occur in Puppis and Vela, retaining the numbering of the former single constellation."]},{"name":"Asselli and Praesepe","meaning":"Dionysus's Asses (Asellus Borealis and Asellus Australis) and Manger (Beehive Cluster)","date":"3rd century BC","creator":"Aratus","position":"middle part of Cancer","wiki":"https://en.wikipedia.org/wiki/Praesepe","paragraphs":["The two Asses and their Manger were an ancient Greek star figure within Cancer. Gamma and Delta Cancri were the northern and southern asses, while the hazy patch between them was Praesepe, the Manger, now known as the Beehive Cluster or M44.","Eratosthenes connected the asses with the war between the Olympian gods and the Giants. Dionysus and Hephaestus were said to have ridden into battle on donkeys. The Giants, who had never heard donkeys bray, mistook the sound for an unknown creature and fled. Dionysus rewarded the animals by placing them in the sky on either side of their feeding trough.","Praesepe also records the appearance of the sky before the telescope. Ptolemy described it as a nebulous mass. In 1609 Galileo observed Praesepe telescopically and resolved the haze into numerous faint stars, identifying the ancient 'mist' as a star cluster."],"source":"https://www.ianridpath.com/startales/cancer.html"},{"name":"Asterion and Chara","meaning":"Northern and Southern Dogs in Canes Venatici","date":"1690","creator":"Johannes Hevelius.","position":"where Canes Venatici is now","wiki":"https://en.wikipedia.org/wiki/Cor_Caroli","note":"Hevelius depicted the two hunting dogs as Asterion and Chara. They were later retained together as Canes Venatici, and Chara survives as the official name of β Canum Venaticorum.","source":"https://www.ianridpath.com/startales/canesvenatici.html"},{"name":"Battery of Volta","meaning":"Battery","date":"1807","creator":"Thomas Young","position":"between Delphinus and Pegasus","wiki":"","paragraphs":["Thomas Young proposed this figure in 1807 in honour of Alessandro Volta's electric battery, a recent invention of electrical science. Like Bode's Machina Electrica, it belonged to the early nineteenth-century fashion for representing contemporary technology among the constellations."]},{"name":"Bufo","meaning":"Toad","date":"1754","creator":"John Hill","position":"tail of Hydra","wiki":""},{"name":"Caesaris Thronus","meaning":"Throne of Caesar","date":"44 BC","creator":"Augustus Caesar","position":"North of Cancer","wiki":""},{"name":"Cancer Minor","meaning":"Lesser Crab","date":"1613","creator":"Petrus Plancius","position":"south-western Gemini","wiki":"https://en.wikipedia.org/wiki/Cancer_Minor"},{"name":"Capra and Haedi","meaning":"Goat Amalthea (stars surrounding Capella) and the Kids (Haedus I and Haedus II)","date":"3rd century BC","creator":"Aratus","position":"eastern Auriga","wiki":"https://en.wikipedia.org/wiki/Haedi","note":"These are remnants of an older Auriga picture that makes Capella's name intelligible. The Charioteer carries the she-goat Amalthea on his shoulder with her Kids beside her; Capella literally means 'little she-goat'.","paragraphs":["Capra and the Haedi, the Goat and the Kids, were once treated as a small star figure associated with Auriga. They account for the livestock in traditional depictions of the Charioteer: Capella represents the goat on his shoulder, while Zeta and Eta Aurigae are the two Kids on his arm.","In Greek myth the goat was usually identified with Amalthea, who nourished the infant Zeus while he was hidden from Kronos in Crete. Later traditions made Amalthea either the goat itself or the nymph who tended it. In one tradition a broken horn of the goat became the cornucopia, or horn of plenty; another connected its hide with the aegis later borne by Zeus.","The names retain the old figure. Capella is Latin for 'little she-goat', while Haedi means 'kids'. Although the group no longer forms an independent constellation, its imagery remains legible in the stellar names."],"source":"https://www.ianridpath.com/startales/auriga.html","images":[{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/Johannes%20Hevelius%20-%20Prodromus%20Astronomia%20-%20Volume%20III%20%22Firmamentum%20Sobiescianum%2C%20sive%20uranographia%22%20-%20Tavola%20X%20-%20Auriga.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:Johannes_Hevelius_-_Prodromus_Astronomia_-_Volume_III_\"Firmamentum_Sobiescianum,_sive_uranographia\"_-_Tavola_X_-_Auriga.jpg","alt":"Auriga carrying the goat and Kids in Hevelius’s atlas, 1690","caption":"Auriga with Capra and the Haedi — Hevelius, 1690"}]},{"name":"Cerberus","meaning":"Cerberus (guardian dog of Hades)","date":"1690","creator":"Johannes Hevelius","position":"eastern Hercules","wiki":"https://en.wikipedia.org/wiki/Cerberus_(constellation)","note":"Hevelius showed Hercules grasping the three-headed guardian of Hades. The figure later merged with the apple-bearing branch Ramus Pomifer, producing the hybrid Cerberus et Ramus before both disappeared back into Hercules.","paragraphs":["Cerberus was the hound of Hades, stationed at the gates of the Underworld to prevent the dead from leaving. Greek and Roman descriptions usually gave him three heads, a serpent for a tail, and additional snakes growing from his body. He was a child of the monsters Typhon and Echidna.","The capture of Cerberus was the twelfth and final labour of Heracles. Before entering the Underworld, Heracles was initiated into the Eleusinian Mysteries. In one influential account, Hades allowed him to take Cerberus to the upper world on condition that he subdued the animal without weapons. Heracles wrestled the hound into submission, brought him alive to King Eurystheus, and then returned him to Hades.","Hevelius represented this episode as a small constellation in the hand of Hercules. His Cerberus resembles a three-headed serpent more closely than a dog. Later mapmakers combined the same stars with Ramus Pomifer, the apple-bearing branch, producing Cerberus et Ramus. The composite figure placed imagery from two different Labours of Heracles in the same part of Hercules."],"source":"https://en.wikipedia.org/wiki/Cerberus_(constellation)","images":[{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/Hev%2011%20fig%20H%20hercules%20et%20cerberus.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:Hev_11_fig_H_hercules_et_cerberus.jpg","alt":"Hercules and Cerberus — Hevelius, 1690","caption":"Hercules and Cerberus — Hevelius, 1690"},{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/Attic%20red-figure%20plate%20with%20Heracles%20and%20Cerberus%20%28Boston%20MFA%2001.8025%29.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:Attic_red-figure_plate_with_Heracles_and_Cerberus_(Boston_MFA_01.8025).jpg","alt":"Heracles leading Cerberus — Attic red-figure plate, late 6th century BC","caption":"Heracles leading Cerberus — Attic red-figure plate, late 6th century BC"}]},{"name":"Cor Caroli Regis Martyris","meaning":"Charles's Heart","date":"1673","creator":"Charles Scarborough","position":"central Canes Venatici","wiki":"https://en.wikipedia.org/wiki/Cor_Caroli#Names","note":"The heart-and-crown figure honoured Charles I. The later association of Cor Caroli with Charles II and the Restoration arose from a nineteenth-century mix-up; the star name itself survived.","source":"https://www.ianridpath.com/startales/canesvenatici.html"},{"name":"Corona Firmiana","meaning":"Corona Borealis renamed to honour Count Leopold Anton von Firmian","date":"1730","creator":"Corbinianus Thomas","position":"where Corona Borealis is now","wiki":""},{"name":"Custos Messium","meaning":"Keeper of harvests","date":"1775","creator":"Jérôme Lalande","position":"between Cassiopeia and Camelopardalis","wiki":"https://en.wikipedia.org/wiki/Custos_Messium","note":"Lalande's 'Keeper of the Harvests' was an astronomical in-joke. The Latin messium echoed the surname of his friend Charles Messier, so French charts often simply called the constellation Messier. The joke has now outlived the constellation: in December 2025 the IAU officially named BE Camelopardalis Custos.","source":"https://en.wikipedia.org/wiki/Custos_Messium","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Sidney%20Hall%20-%20Urania%27s%20Mirror%20-%20Camelopardalis%2C%20Tarandus%20and%20Custos%20Messium.png?width=900","imagePage":"https://commons.wikimedia.org/wiki/File:Sidney_Hall_-_Urania's_Mirror_-_Camelopardalis,_Tarandus_and_Custos_Messium.png","imageAlt":"Urania's Mirror: Camelopardalis, Tarandus and Custos Messium","paragraphs":["Lalande introduced Custos Messium after tracing the comet C/1774 P1 through a patch of faint northern stars that lacked an established figure. The constellation was a harvest keeper, but its Latin name contained a pun: messium, 'of the harvests', echoed the surname of Lalande's friend Charles Messier, the comet hunter.","The tribute was indirect because placing a living person openly among the constellations could be considered improper. French charts often made the pun more explicit by calling the figure Le Messier. Its position among Cassiopeia, Cepheus and Camelopardalis gave the dedication a pastoral form.","The constellation disappeared, but the name later returned. In 2025 the IAU Working Group on Star Names approved Custos for BE Camelopardalis, retaining both the harvest keeper and the pun on Messier in an official star name."]},{"name":"Deltoton","meaning":"Delta (obsolete name for Triangulum Boreale)","date":"1540","creator":"Petrus Apianus","position":"Triangulum","wiki":""},{"name":"Dentalium","meaning":"Tooth Shell","date":"1754","creator":"John Hill","position":"between Aquila and Aquarius","wiki":""},{"name":"Duae Alae","meaning":"Two Wings","date":"1532","creator":"Petrus Apianus","position":"Between Cygnus and Draco","wiki":""},{"name":"Felis","meaning":"Cat","date":"1799","creator":"Jérôme Lalande","position":"southern Hydra","wiki":"https://en.wikipedia.org/wiki/Felis_(constellation)","note":"Lalande openly wanted a cat in the heavens. After filling a lifetime with astronomy, he carved Felis out of faint stars beside Hydra—an unusually personal addition among the many heroic and scientific figures of old atlases. The constellation disappeared, but one of its stars was officially named Felis by the IAU in 2018.","source":"https://en.wikipedia.org/wiki/Felis_(constellation)","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Sidney%20Hall%20-%20Urania%27s%20Mirror%20-%20Noctua%2C%20Corvus%2C%20Crater%2C%20Sextans%20Urani%C3%A6%2C%20Hydra%2C%20Felis%2C%20Lupus%2C%20Centaurus%2C%20Antlia%20Pneumatica%2C%20Argo%20Navis%2C%20and%20Pyxis%20Nautica.jpg?width=900","imagePage":"https://commons.wikimedia.org/wiki/File:Sidney_Hall_-_Urania's_Mirror_-_Noctua,_Corvus,_Crater,_Sextans_Urani%C3%A6,_Hydra,_Felis,_Lupus,_Centaurus,_Antlia_Pneumatica,_Argo_Navis,_and_Pyxis_Nautica.jpg","imageAlt":"Urania's Mirror showing Felis and neighbouring constellations","paragraphs":["Jérôme Lalande created Felis because he wanted a domestic cat represented among the constellations. He noted that the sky already contained lions and a lynx but no ordinary cat, and in 1799 he formed Felis from faint stars beside Hydra.","Felis had no ancient myth or scientific instrument associated with it; Lalande's own preference was its stated basis. Bode included the Cat in his Uranographia of 1801, giving the new figure a place among the elaborate constellations of the period.","Felis disappeared as a constellation, but the name was later revived. In 2018 the IAU approved Felis as the proper name of HD 85951, one of the stars that had belonged to the former Cat."]},{"name":"Frederici Honores","meaning":"Frederick's Honors","date":"1787","creator":"Johann Elert Bode","position":"Northeastern Andromeda","wiki":"https://en.wikipedia.org/wiki/Frederici_Honores","note":"Northeastern Andromeda was used more than once for royal symbolism. Royer's Sceptrum et Manus Iustitiae had occupied essentially the same region before Bode replaced it with Frederick's honours."},{"name":"Gallus","meaning":"Rooster","date":"1613","creator":"Petrus Plancius","position":"Northern Puppis","wiki":"https://en.wikipedia.org/wiki/Gallus_(constellation)"},{"name":"Gladii Electorales Saxonici","meaning":"Crossed Swords of the Electorate of Saxony","date":"1684","creator":"Gottfried Kirch","position":"Between Boötes, Leo, Scutum, and Virgo","wiki":""},{"name":"Globus Aerostaticus","meaning":"Hot air balloon","date":"1798","creator":"Jérôme Lalande","position":"south of Capricornus and Piscis Austrinus","wiki":"https://en.wikipedia.org/wiki/Globus_Aerostaticus","note":"The Montgolfier age reached the sky astonishingly quickly. Only a few years after the first crewed balloon flights, Lalande placed a hot-air balloon among the southern stars. Urania's Mirror even drew it as a fully inflated balloon: a brief moment when the newest human technology looked worthy of becoming eternal mythology.","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Sidney%20Hall%20-%20Urania%27s%20Mirror%20-%20Aquarius%2C%20Piscis%20Australis%20%26%20Ballon%20Aerostatique.jpg?width=900","imagePage":"https://commons.wikimedia.org/wiki/File:Sidney_Hall_-_Urania's_Mirror_-_Aquarius,_Piscis_Australis_&_Ballon_Aerostatique.jpg","imageAlt":"Urania's Mirror showing the Balloon","paragraphs":["Lalande created Globus Aerostaticus in 1798 to honour the Montgolfier brothers and the invention of the hot-air balloon, fifteen years after the first crewed flights of 1783. The constellation was a direct product of the contemporary balloon age.","The figure belongs to a period in which European star atlases increasingly included contemporary technology alongside inherited gods and animals. Balloons, printing presses, electrical machines and telescopes all appeared as proposed constellations. Globus Aerostaticus treated a recent technological invention as material for celestial imagery."],"source":"https://en.wikipedia.org/wiki/Globus_Aerostaticus"},{"name":"Gryphites","meaning":"Gryphaea shellfish","date":"1754","creator":"John Hill","position":"","wiki":""},{"name":"Hippocampus","meaning":"Sea Horse","date":"1754","creator":"John Hill","position":"Between Eridanus, Taurus, and Cetus","wiki":""},{"name":"Hirudo","meaning":"Leech","date":"1754","creator":"John Hill","position":"Northern Orion","wiki":""},{"name":"Jordanus","meaning":"River Jordan","date":"1613","creator":"Petrus Plancius","position":"","wiki":"https://en.wikipedia.org/wiki/Jordanus_(constellation)","note":"Plancius's River Jordan ran beneath Ursa Major. Hevelius later used much of the same region for Canes Venatici, Leo Minor and Lynx.","source":"https://www.ianridpath.com/startales/ptolemy-spare.html"},{"name":"Leo Palatinus","meaning":"Lion to honour the Elector Palatine Charles Theodore and his wife Elisabeth Auguste","date":"1785","creator":"Karl-Joseph König","position":"","wiki":"https://en.wikipedia.org/wiki/Leo_Palatinus"},{"name":"Lilium","meaning":"Fleur de Lys (renamed Musca Borealis)","date":"1679","creator":"Augustin Royer/P. Anthelme","position":"","wiki":"https://en.wikipedia.org/wiki/Lilium_(constellation)"},{"name":"Limax","meaning":"Slug","date":"1754","creator":"John Hill","position":"","wiki":""},{"name":"Linum Piscium","meaning":"The line connecting the fish (renamed by Bode in 1801 from Hevelius's Linum Austrinum and Linum Boreum; known as Lineola too)","date":"1590","creator":"Thomas Hood","position":"","wiki":""},{"name":"Lochium Funis","meaning":"Log line (renamed Linea Nautica in 1888 by Eliza A. Bowen)","date":"1801","creator":"Johann Elert Bode","position":"","wiki":"https://en.wikipedia.org/wiki/Lochium_Funis"},{"name":"Lumbricus","meaning":"Earthworm","date":"1754","creator":"John Hill","position":"","wiki":""},{"name":"Machina Electrica","meaning":"Electricity generator","date":"1800","creator":"Johann Elert Bode","position":"south of Cetus, between Fornax and Sculptor","wiki":"https://en.wikipedia.org/wiki/Machina_Electrica","note":"Bode turned the new science of electricity into a constellation: an electrostatic generator sitting beside other instrument-themed figures in the southern sky. It appeared prominently in his 1801 Uranographia and in later illustrated atlases, but never gained the broad acceptance of Lacaille's surviving scientific constellations.","source":"https://en.wikipedia.org/wiki/Machina_Electrica","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Sidney%20Hall%20-%20Urania%27s%20Mirror%20-%20Psalterium%20Georgii%2C%20Fluvius%20Eridanus%2C%20Cetus%2C%20Officina%20Sculptoris%2C%20Fornax%20Chemica%2C%20and%20Machina%20Electrica.jpg?width=900","imagePage":"https://commons.wikimedia.org/wiki/File:Sidney_Hall_-_Urania's_Mirror_-_Psalterium_Georgii,_Fluvius_Eridanus,_Cetus,_Officina_Sculptoris,_Fornax_Chemica,_and_Machina_Electrica.jpg","imageAlt":"Urania's Mirror showing Machina Electrica","paragraphs":["Bode introduced Machina Electrica around 1800 in honour of the electrical generator, using faint stars in southern Cetus. It was one of several late eighteenth- and early nineteenth-century figures based on contemporary instruments and technologies.","Electricity was still a rapidly developing experimental science when Bode published Uranographia in 1801. The electrical machine therefore represented current technology rather than an inherited or antiquarian emblem."]},{"name":"Malus","meaning":"Mast","date":"1844","creator":"John Herschel","position":"Where Pyxis is now","wiki":"https://en.wikipedia.org/wiki/Malus_(constellation)"},{"name":"Manis","meaning":"Pangolin","date":"1754","creator":"John Hill","position":"Between Andromeda, Lacerta, and Cygnus","wiki":""},{"name":"Marmor Sculptile","meaning":"Bust of Columbus","date":"1810","creator":"William Croswell","position":"","wiki":""},{"name":"Mons Maenalus","meaning":"Mount Mainalo","date":"1690","creator":"Johannes Hevelius","position":"Southern Boötes","wiki":"https://en.wikipedia.org/wiki/Mons_Maenalus","note":"Hevelius placed Mount Maenalus beneath Boötes's feet, turning the constellation picture into a landscape rather than a lone figure. The mountain came from Arcadian mythology, the homeland of the hunter Arcas. The mountain was later discarded as a constellation, but the name Maenalus survives as a modern star name.","source":"https://en.wikipedia.org/wiki/Mons_Maenalus","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Bootes2.jpg?width=900","imagePage":"https://commons.wikimedia.org/wiki/File:Bootes2.jpg","imageAlt":"Bode's Boötes region with Mons Maenalus","paragraphs":["Hevelius placed Boötes on Mount Maenalus, a real mountain in Arcadia, and used it to fill the space beneath the Herdsman's feet. The mountain was sacred to Pan and associated with the hunting country of Arcadia.","One mythological identification of Boötes made him Arcas, son of Zeus and Callisto and a prince of Arcadia. Callisto had been transformed into a bear. When the adult Arcas encountered her while hunting, he did not recognise his mother and was about to kill her. Zeus intervened and placed them in the sky as the Bear and her keeper. In this interpretation, Hevelius's Arcadian mountain lay beneath a figure identified with an Arcadian prince, although the connection was not part of the ancient constellation.","The obsolete name later returned to stellar nomenclature. In 2026 the IAU Working Group on Star Names adopted Maenalus for 109 Virginis, a star that belonged to Hevelius's original mountain."]},{"name":"Musca Borealis","meaning":"Northern Fly","date":"1690","creator":"Johannes Hevelius","position":"","wiki":"https://en.wikipedia.org/wiki/Musca_Borealis"},{"name":"Noctua","meaning":"Owl","date":"1822","creator":"Alexander Jamieson","position":"","wiki":"https://en.wikipedia.org/wiki/Noctua_(constellation)","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Noctua.JPG?width=900","imagePage":"https://commons.wikimedia.org/wiki/File:Noctua.JPG","imageAlt":"Noctua, the Owl","note":"The owl was the final form of a patch of sky that repeatedly changed bird. Le Monnier had first made it Turdus Solitarius, honouring the extinct Rodrigues solitaire; later charts turned it into a mockingbird, and Jamieson finally made it Noctua, the Owl. Urania's Mirror preserves the owl perched above Hydra.","paragraphs":["Noctua, the Owl, was the last of several bird figures placed on the tail of Hydra. Le Monnier had first used the stars for the Rodrigues solitaire in 1776; later maps showed a solitary thrush or a mockingbird. Alexander Jamieson replaced the bird with an owl in 1822, and Urania's Mirror popularised that form.","The Rodrigues solitaire was a large flightless bird related to the dodo and native only to Rodrigues in the Indian Ocean. It was already extinct by the period in which these later atlases were produced. The same stars thus passed through several bird identities, including one based on an animal that had itself disappeared.","Part of the earlier history returned in 2024, when the IAU approved Solitaire as the proper name of 58 Hydrae."],"source":"https://en.wikipedia.org/wiki/Noctua_(constellation)"},{"name":"Norma Nilotica","meaning":"Nilometer","date":"1822","creator":"Alexander Jamieson","position":"Western edge of Aquarius","wiki":"https://en.wikipedia.org/wiki/Norma_Nilotica_(constellation)"},{"name":"Nubecula Major and Nubecula Minor","meaning":"Magellanic Clouds","date":"1603","creator":"Johann Bayer","position":"","wiki":"https://en.wikipedia.org/wiki/Nubecula_Major"},{"name":"Officina Typographica","meaning":"Printshop","date":"1801","creator":"Johann Elert Bode","position":"east of Sirius, mostly in modern Puppis","wiki":"https://en.wikipedia.org/wiki/Officina_Typographica","note":"Bode commemorated the printing press itself—a fitting monument from an era in which printed atlases were rapidly changing how the sky was standardised and shared. In Urania's Mirror it appears as a little working printshop beside Monoceros and Canis Minor.","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Sidney%20Hall%20-%20Urania%27s%20Mirror%20-%20Monoceros%2C%20Canis%20Minor%2C%20and%20Atelier%20Typographique.jpg?width=900","imagePage":"https://commons.wikimedia.org/wiki/File:Sidney_Hall_-_Urania's_Mirror_-_Monoceros,_Canis_Minor,_and_Atelier_Typographique.jpg","imageAlt":"Urania's Mirror showing the printing workshop","paragraphs":["Officina Typographica represented a printing workshop and was created by Bode and Lalande in the late 1790s in honour of Gutenberg's printing press. Lalande wanted to commemorate French and German inventions in the sky, following Lacaille's precedent of southern constellations devoted to scientific instruments.","Printing had a direct connection with the atlas in which the figure appeared. Bode's Uranographia, which depicted Officina Typographica, was itself produced and circulated through the technology that the constellation commemorated."],"source":"https://en.wikipedia.org/wiki/Officina_Typographica"},{"name":"Patella","meaning":"Limpet","date":"1754","creator":"John Hill","position":"","wiki":""},{"name":"Phaethon","meaning":"Phaethon","date":"Middle Ages","creator":"Aratus/Hyginus","position":"","wiki":"https://en.wikipedia.org/wiki/Phaethon","paragraphs":["Phaethon was the son of the sun-god Helios in a Greek myth of celestial disaster. Seeking proof of his divine parentage, he asked Helios to let him drive the chariot of the Sun for one day. Helios warned that even Zeus could not safely guide the fiery horses, but Phaethon refused to withdraw the request.","Phaethon lost control of the horses. In different versions, the chariot climbed too high and chilled the Earth, then descended so low that it scorched the land. Zeus ended the catastrophe with a thunderbolt. Phaethon fell blazing into the river Eridanus, while his grieving sisters, the Heliades, were transformed into poplar trees whose tears became amber.","Ancient and later mythographers sometimes identified Phaethon with Auriga instead of maintaining a stable independent constellation for him. His appearance among former constellations therefore represents a lost or alternative identification of the Charioteer region with the disastrous driver of the Sun."],"source":"https://en.wikipedia.org/wiki/Phaethon","images":[{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/La%20Chute%20de%20Pha%C3%A9ton.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:La_Chute_de_Pha%C3%A9ton.jpg","alt":"The fall of Phaethon — historical engraving","caption":"The fall of Phaethon — historical engraving"}]},{"name":"Phoenicopterus","meaning":"Flamingo (an obsolete name for Grus)","date":"early 17th century","creator":"Petrus Plancius/Paulus Merula","position":"where Grus is now","wiki":"https://en.wikipedia.org/wiki/Phoenicopterus_(constellation)"},{"name":"Pinna Marina","meaning":"Mussel","date":"1754","creator":"John Hill","position":"","wiki":""},{"name":"Piscis Notus","meaning":"Southern Fish (obsolete name for Piscis Austrinus)","date":"3rd century BC","creator":"Aratus","position":"where Piscis Austrinus is now","wiki":"https://en.wikipedia.org/wiki/Piscis_Austrinus"},{"name":"Plaustrum","meaning":"Chariot with 3 horses","date":"1524","creator":"Petrus Apianus","position":"Big Dipper","wiki":""},{"name":"Pluteum","meaning":"Parapet (obsolete for Pictor)","date":"1881","creator":"Richard Andree","position":"where Pictor is now","wiki":""},{"name":"Polophylax","meaning":"Guardian of the Pole","date":"1592","creator":"Petrus Plancius","position":"","wiki":"https://en.wikipedia.org/wiki/Polophylax","paragraphs":["Polophylax, the Guardian of the Pole, appeared on Petrus Plancius's world maps of 1592 and 1594 in the far southern sky. European astronomers were then assigning figures to stars beyond the old Ptolemaic constellations, much of which was poorly known from northern Europe.","The figure occupied the southern polar region only briefly. A few years later Plancius obtained much better southern observations from the Dutch voyages of Pieter Dircksz Keyser and Frederik de Houtman. He used them to form the twelve southern constellations that became familiar today, and Polophylax was superseded. Its short history coincided with the rapid expansion of European knowledge of the southern sky."],"source":"https://en.wikipedia.org/wiki/Polophylax"},{"name":"Pomum Imperiale","meaning":"Leopold's orb","date":"1688","creator":"Gottfried Kirch","position":"","wiki":""},{"name":"Proctor's renamed constellations","meaning":"A proposed replacement vocabulary for 16 existing constellations","date":"1873","creator":"Richard Proctor","position":"across the established northern and southern sky","wiki":""},{"name":"Psalterium Georgii","meaning":"George's Psaltery (renamed to Harp Georgii by Lalande)","date":"1781","creator":"Maximilian Hell","position":"","wiki":"https://en.wikipedia.org/wiki/Psalterium_Georgii","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Sidney%20Hall%20-%20Urania%27s%20Mirror%20-%20Psalterium%20Georgii%2C%20Fluvius%20Eridanus%2C%20Cetus%2C%20Officina%20Sculptoris%2C%20Fornax%20Chemica%2C%20and%20Machina%20Electrica.jpg?width=900","imagePage":"https://commons.wikimedia.org/wiki/File:Sidney_Hall_-_Urania's_Mirror_-_Psalterium_Georgii,_Fluvius_Eridanus,_Cetus,_Officina_Sculptoris,_Fornax_Chemica,_and_Machina_Electrica.jpg","imageAlt":"Urania's Mirror showing Psalterium Georgii","note":"Maximilian Hell named this small constellation for the psaltery of King George II. Lalande later recast it as Harp Georgii. The successive names show how readily a celestial honour could change when the same faint stars were redrawn by another astronomer."},{"name":"Quadrans Muralis","meaning":"Mural Quadrant","date":"1795","creator":"Jérôme Lalande","position":"between Boötes and Draco","wiki":"https://en.wikipedia.org/wiki/Quadrans_Muralis","note":"Lalande's wall-mounted astronomical quadrant vanished from the official sky, but its ghost is unusually easy to meet: the Quadrantid meteor shower still carries its name because the radiant was originally described inside Quadrans Muralis. In February 2025 the IAU went one step further and officially named 44 Boötis A Quadrans.","source":"https://en.wikipedia.org/wiki/Quadrans_Muralis","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Sidney%20Hall%2C%20Bo%C3%B6tes%2C%20Canes%20Venatici%2C%20Coma%20Berenices%2C%20and%20Quadrans%20Muralis%2C%201825.jpg?width=900","imagePage":"https://commons.wikimedia.org/wiki/File:Sidney_Hall,_Bo%C3%B6tes,_Canes_Venatici,_Coma_Berenices,_and_Quadrans_Muralis,_1825.jpg","imageAlt":"Urania's Mirror showing Quadrans Muralis","paragraphs":["Lalande created Quadrans Muralis in 1795 to represent the wall-mounted quadrant used by him and his nephew Michel Lefrançois de Lalande for positional astronomy. The instrument was fixed to a wall aligned with the meridian and used to measure stellar altitudes precisely. The constellation commemorated this practical instrument of positional astronomy.","The Quadrantid meteor shower retained the old constellation's name. Its radiant lay in Quadrans Muralis when the shower was named, and the meteor-shower designation continued after the constellation disappeared from modern charts.","In 2025 the IAU approved Quadrans as the proper name of 44 Boötis A, the brightest star in Lalande's original figure. The historical sequence now runs from the mural quadrant to the constellation, from the constellation to the Quadrantids, and from the lost constellation to the modern star name."]},{"name":"Quadratum","meaning":"Rhombus (obsolete name for Reticulum Rhomboidalis)","date":"1706","creator":"Carel Allard","position":"","wiki":""},{"name":"Quinque Dromedarii","meaning":"Five Camels","date":"1532","creator":"Petrus Apianus","position":"Southern Draco","wiki":""},{"name":"Ramus Pomifer","meaning":"Apple-bearing Branch","date":"1690","creator":"Johannes Hevelius","position":"","wiki":"https://en.wikipedia.org/wiki/Ramus_Pomifer","paragraphs":["Ramus Pomifer, the Apple-Bearing Branch, was drawn in the left hand of Hercules. It represented the golden apples of the Hesperides, the object of another of Heracles' labours. The apples grew in Hera's garden and were guarded by the dragon Ladon. In some versions Heracles killed Ladon himself; in others Atlas fetched the apples after Heracles temporarily took the burden of the heavens on his shoulders.","The branch occupied nearly the same stars as Hevelius's Cerberus. Later cartographers combined the two as Cerberus et Ramus. The resulting figure showed Hercules holding both the guardian of Hades and the apples of the Hesperides, imagery from two separate mythological adventures.","The name Ramus returned in 2025, when the IAU approved it for 102 Herculis."],"source":"https://en.wikipedia.org/wiki/Ramus_Pomifer","images":[{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/Fourth-century%20hydria%20ARV%20extra%20-%20Herakles%20in%20the%20garden%20of%20the%20Hesperides%20%2801%29.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:Fourth-century_hydria_ARV_extra_-_Herakles_in_the_garden_of_the_Hesperides_(01).jpg","alt":"Heracles in the Garden of the Hesperides on an Attic red-figure hydria","caption":"Heracles in the Garden of the Hesperides — Attic red-figure hydria"}]},{"name":"Robur Carolinum","meaning":"Charles' Oak","date":"1679","creator":"Edmund Halley","position":"within the old Argo Navis","wiki":"https://en.wikipedia.org/wiki/Robur_Carolinum","note":"Halley invented Charles's Oak after observing the southern sky from St Helena. It commemorated the Royal Oak in which the future Charles II hid after defeat at the Battle of Worcester in 1651. Halley borrowed conspicuous stars from Argo Navis to build the oak, making the chart both astronomy and unmistakable Restoration-era politics.","source":"https://en.wikipedia.org/wiki/Robur_Carolinum","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Halley%27s%20Argo%20and%20Robur%20Carolinum.jpg?width=900","imagePage":"https://commons.wikimedia.org/wiki/File:Halley's_Argo_and_Robur_Carolinum.jpg","imageAlt":"Halley's Argo Navis and Robur Carolinum","paragraphs":["Edmond Halley created Robur Carolinum, Charles's Oak, in 1679 to honour his patron King Charles II. The name referred to the Royal Oak at Boscobel, in which the future king was said to have hidden after the royalist defeat at the Battle of Worcester in 1651 while escaping Parliamentary forces.","Halley placed the oak in the southern sky that he had charted from Saint Helena. To form the new constellation he reassigned several bright stars from the ancient Argo Navis. Nicolas-Louis de Lacaille later objected to the removal of some of Argo's brightest stars for a royal memorial.","Robur Carolinum commemorated recent English political history in the southern sky. It remained in atlases for more than a century before its stars returned to the constellations around Carina and Vela."]},{"name":"Rosa","meaning":"Rose","date":"1536","creator":"Petrus Apianus","position":"","wiki":""},{"name":"Sagitta Australis","meaning":"Southern Arrow","date":"1613","creator":"Petrus Plancius","position":"","wiki":""},{"name":"Scarabaeus","meaning":"Rhinoceros Beetle","date":"1754","creator":"John Hill","position":"","wiki":""},{"name":"Sceptrum Brandenburgicum","meaning":"Sceptre of Brandenburg","date":"1688","creator":"Gottfried Kirch","position":"","wiki":"https://en.wikipedia.org/wiki/Sceptrum_Brandenburgicum","note":"Kirch created the sceptre in honour of Brandenburg. The constellation disappeared, but its name remained in catalogues; 53 Eridani A now officially carries the star name Sceptrum."},{"name":"Sceptrum et Manus Iustitiae","meaning":"Sceptre and Hand of Justice","date":"1679","creator":"Augustin Royer","position":"Northeastern Andromeda, where Honores Fredirici was","wiki":"https://en.wikipedia.org/wiki/Sceptrum_et_Manus_Iustitiae"},{"name":"Sciurus Volans","meaning":"Flying Squirrel (now part of Camelopardalis)","date":"1810","creator":"William Croswell","position":"","wiki":""},{"name":"Sextans Uraniae","meaning":"Urania's Sextant (obsolete name for Sextans)","date":"1690","creator":"Johannes Hevelius","position":"","wiki":"https://en.wikipedia.org/wiki/Sextans","paragraphs":["Sextans Uraniae, 'Urania's Sextant', commemorated the large sextant with which Hevelius measured stellar positions. Hevelius continued to make very precise naked-eye measurements after telescopic sights had become available, and the sextant was central to his programme of positional astronomy.","In September 1679 a fire destroyed Hevelius's houses, observatory, printing equipment, books and most of his astronomical instruments. Contemporary accounts specifically list the great metal sextant among the losses. Hevelius rebuilt the observatory and resumed observing; the constellation became a permanent celestial counterpart to the destroyed instrument.","The figure itself survived. Its name was shortened to Sextans, one of Hevelius's seven new constellations still recognised today. Sextans Uraniae is a former form of the name rather than a former constellation in the usual sense."],"images":[{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/Johannes%20Hevelius%20-%20Prodromus%20Astronomia%20-%20Volume%20III%20%22Firmamentum%20Sobiescianum%2C%20sive%20uranographia%22%20-%20Tavola%20VV%20-%20Sextans%20Uraniae.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:Johannes_Hevelius_-_Prodromus_Astronomia_-_Volume_III_\"Firmamentum_Sobiescianum,_sive_uranographia\"_-_Tavola_VV_-_Sextans_Uraniae.jpg","alt":"Sextans Uraniae in Hevelius’s atlas, 1690","caption":"Sextans Uraniae — Hevelius, 1690"}],"source":"https://mathshistory.st-andrews.ac.uk/Extras/Hevelius_fire/"},{"name":"Siren, Ceneus and Lang","meaning":"Siren, Lapith Caeneus and Lang","date":"early 17th century","creator":"Unknown/Willem Jansz Blaeu","position":"where Chamaeleon, Musca, Tucana and Triangulum Australe now are","wiki":""},{"name":"Solarium","meaning":"Sundial","date":"1822","creator":"Alexander Jamieson","position":"Replacement for Reticulum","wiki":"https://en.wikipedia.org/wiki/Solarium_(constellation)"},{"name":"Sudarium Veronicae","meaning":"Sudarium of Veronica","date":"1643","creator":"Antoine Marie Schyrle de Rheita","position":"between Leo, Hydra and Sextans","wiki":""},{"name":"Tarabellum and Vexillum","meaning":"Drill and flag-like Standard","date":"12th century","creator":"Michael Scot","position":"between Leo and Virgo","wiki":""},{"name":"Tarandus or Rangifer","meaning":"Reindeer","date":"1743","creator":"Pierre Charles Lemonnier","position":"Between Cassiopeia, and Camelopardalis","wiki":"https://en.wikipedia.org/wiki/Rangifer_(constellation)","note":"Le Monnier had travelled with Maupertuis's 1736–37 expedition to Lapland, whose measurements helped establish that Earth is flattened at the poles. There he encountered Sámi reindeer sky tradition; in 1743 he introduced Rangifer, the Reindeer, into a faint northern gap. Later atlases also called it Tarandus. In December 2025 the IAU preserved both names separately as the official star names Rangifer and Tarandus.","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Sidney%20Hall%20-%20Urania%27s%20Mirror%20-%20Camelopardalis%2C%20Tarandus%20and%20Custos%20Messium.png?width=900","imagePage":"https://commons.wikimedia.org/wiki/File:Sidney_Hall_-_Urania's_Mirror_-_Camelopardalis,_Tarandus_and_Custos_Messium.png","imageAlt":"Urania's Mirror showing Tarandus","source":"https://en.wikipedia.org/wiki/Rangifer_(constellation)","paragraphs":["Pierre Charles Le Monnier created the Reindeer after taking part in Pierre Louis Maupertuis's expedition to Lapland, whose geodetic measurements helped demonstrate that the Earth is flattened at the poles. The animal suited the Lapland association, and Le Monnier placed the small circumpolar figure between Cassiopeia and Camelopardalis.","The constellation circulated under Rangifer and Tarandus, two Latin names for reindeer. Sámi sky traditions also contain a much larger celestial reindeer, Sarvvis. Modern historical work has raised the possibility that Le Monnier's northern figure was influenced by what the expedition encountered in Lapland.","In 2025 the IAU Working Group on Star Names revived both historical names separately, assigning Rangifer to 49 Cassiopeiae and Tarandus to 2 Ursae Minoris. The same WGSN programme also adopted Sámi-derived names including Sarvvis, placing European and Indigenous northern-sky nomenclature in the same modern catalogue."]},{"name":"Taurus Poniatovii","meaning":"Poniatowski's Bull","date":"1777","creator":"Marcin Poczobut","position":"between Ophiuchus and Serpens Cauda","wiki":"https://en.wikipedia.org/wiki/Taurus_Poniatovii","note":"Poczobut noticed a compact V-shaped pattern that recalled the Hyades—the V forming the face of Taurus—and used it to create a second bull for King Stanisław August Poniatowski of Poland. The royal bull later disappeared, leaving its stars split between Ophiuchus and Serpens Cauda.","source":"https://en.wikipedia.org/wiki/Taurus_Poniatovii","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Taurus%20Poniatovii.PNG?width=900","imagePage":"https://commons.wikimedia.org/wiki/File:Taurus_Poniatovii.PNG","imageAlt":"Bode's Taurus Poniatovii","paragraphs":["Marcin Poczobutt created Taurus Poniatovii in 1777 to honour Stanisław August Poniatowski, King of Poland and Grand Duke of Lithuania. The royal bull was placed between Ophiuchus, Aquila and Serpens Cauda.","Poczobutt also chose the bull because its principal stars formed a conspicuous V resembling the Hyades, which make the V-shaped face of Taurus. Taurus Poniatovii was therefore designed as a second bull with a visual resemblance to the zodiacal Taurus.","The five brightest stars of the former figure are now recognised as a loose stellar grouping, and Barnard's Star lies within its former area. A drawing of Taurus Poniatovii remains on the wall of the astronomical observatory at Vilnius University, where Poczobutt was rector."]},{"name":"Telescopium Herschelii","meaning":"Herschel's Telescope (renamed from Tubus Herschelii Major by Bode in 1801)","date":"1789","creator":"Maximilian Hell","position":"","wiki":"https://en.wikipedia.org/wiki/Telescopium_Herschelii","note":"Hell honoured William Herschel with telescope constellations soon after Herschel's discovery of Uranus. Bode later depicted the larger instrument as Telescopium Herschelii: a celestial monument not to a mythic hero but to a living astronomer and the machine that had just expanded the known Solar System.","image":"https://commons.wikimedia.org/wiki/Special:FilePath/Sidney%20Hall%20-%20Urania%27s%20Mirror%20-%20Lynx%20and%20Telescopium%20Herschilii.jpg?width=900","imagePage":"https://commons.wikimedia.org/wiki/File:Sidney_Hall_-_Urania's_Mirror_-_Lynx_and_Telescopium_Herschilii.jpg","imageAlt":"Urania's Mirror showing Telescopium Herschelii","paragraphs":["Maximilian Hell created Telescopium Herschelii in 1789 to honour William Herschel's discovery of Uranus in 1781. It was one of two telescope constellations devised by Hell for Herschel: a larger instrument in Auriga and a smaller one between Taurus and Orion.","Hell intended the larger figure to represent Herschel's long telescope. Bode later renamed it Telescopium Herschelii and redrew it in Uranographia using a different Herschel instrument. The telescope was placed near the region in which Uranus had first been noticed, linking the commemorative figure with the discovery.","Uranus was the first planet discovered with a telescope. Within a decade of the discovery, both Herschel and his instrument had been commemorated by a constellation, illustrating the speed with which eighteenth-century astronomers could add recent scientific events to star maps."],"source":"https://en.wikipedia.org/wiki/Telescopium_Herschelii"},{"name":"Testudo","meaning":"Tortoise","date":"1754","creator":"John Hill","position":"Between Cetus and Pisces","wiki":"https://en.wikipedia.org/wiki/Pisces_(constellation)#History_and_mythology"},{"name":"Tigris","meaning":"Tigris River","date":"1613","creator":"Petrus Plancius","position":"","wiki":"https://en.wikipedia.org/wiki/River_Tigris_(constellation)"},{"name":"Triangulum Majus","meaning":"Large Triangle (obsolete name for Triangulum)","date":"1690","creator":"Johannes Hevelius","position":"where Triangulum is now","wiki":"https://en.wikipedia.org/wiki/Triangulum"},{"name":"Triangulum Minus","meaning":"Small Triangle","date":"1690","creator":"Johannes Hevelius","position":"","wiki":"https://en.wikipedia.org/wiki/Triangulum_Minus"},{"name":"Triangulus Antarcticus","meaning":"Obsolete name for Triangulum Australe","date":"1589","creator":"Petrus Plancius","position":"","wiki":""},{"name":"Tubus Herschelii Minor","meaning":"Herschel's Reflector","date":"1789","creator":"Maximilian Hell","position":"","wiki":"","paragraphs":["Tubus Herschelii Minor was the smaller companion to Hell's large Herschel telescope constellation. The pair commemorated William Herschel and the discovery of Uranus, with the smaller telescope placed between Taurus and Orion.","Bode retained only the larger tribute in Uranographia in 1801. Tubus Herschelii Minor consequently disappeared along with the paired scheme and survives chiefly in the history of the rapid astronomical commemoration of Herschel's discovery."],"source":"https://en.wikipedia.org/wiki/Telescopium_Herschelii"},{"name":"Turdus Solitarius","meaning":"Solitary Thrush (renamed to Mocking Bird and then to Noctua). Named in honour of the Rodrigues solitaire, an extinct flightless bird related to the dodo.","date":"1776","creator":"Pierre Charles Lemonnier","position":"","wiki":"https://en.wikipedia.org/wiki/Turdus_Solitarius","note":"Le Monnier named this bird for the Rodrigues solitaire, an extinct flightless relative of the dodo. The same stars later became a mockingbird and then Noctua, the Owl. In 2024 the IAU named 58 Hydrae Solitaire, so the extinct bird and the extinct constellation now survive together in a modern official star name.","paragraphs":["Le Monnier created this bird from stars on Hydra's tail in 1776. Its intended subject was the Rodrigues solitaire, a large flightless bird related to the dodo that lived only on Rodrigues and became extinct during the eighteenth century.","The Latin name Turdus Solitarius means 'solitary thrush', and atlas illustrations showed a small perching bird instead of the heavy, flightless Rodrigues solitaire. Later maps reinterpreted the same stars as a mockingbird and finally as Noctua, the Owl.","In 2024 the IAU approved Solitaire as the proper name of 58 Hydrae. The modern star name retains the name of both the extinct bird and the former constellation."],"source":"https://en.wikipedia.org/wiki/Turdus_Solitarius"},{"name":"Turris Eiffel","meaning":"Eiffel Tower","date":"1922","creator":"Ezequiel de Moraes Leme","position":"Between Centaurus and Lupus","wiki":"https://en.wikipedia.org/wiki/Former_constellations#cite_note-53","note":"Ezequiel de Moraes Leme proposed an Eiffel Tower between Centaurus and Lupus in 1922. The IAU adopted its first official list of constellations in the same year, placing Turris Eiffel at the end of the period in which Western astronomers could still propose new constellation figures freely."},{"name":"Uranoscopus","meaning":"Star-Gazer fish","date":"1754","creator":"John Hill","position":"","wiki":""},{"name":"Urna","meaning":"Urn of Aquarius","date":"1596","creator":"Zacharias Bornmann","position":"","wiki":""},{"name":"Vespa","meaning":"Wasp (an obsolete name for Musca Borealis)","date":"1624","creator":"Jakob Bartsch","position":"","wiki":"https://en.wikipedia.org/wiki/Vespa_(constellation)"},{"name":"Xiphias","meaning":"Swordfish (An obsolete name for Dorado)","date":"1627","creator":"Johannes Kepler","position":"Where Dorado is now","wiki":""}];

  const INTERESTING_STAR_STORIES = [{"group":"Names that map the picture","title":"Rasalhague & Unukalhai","stars":"α Ophiuchi · α Serpentis","key":"head of the Serpent Bearer · neck of the Serpent","paragraphs":["Rasalhague, α Ophiuchi, derives from an Arabic expression meaning the head of the serpent-bearer. Its position is literal: it lies at the head of Ophiuchus. Unukalhai, α Serpentis, comes from Arabic for the serpent's neck and lies in the corresponding part of Serpens.","Ophiuchus and Serpens form one of the largest connected figures in the traditional sky. Ophiuchus is usually identified with Asclepius, the divine physician. In Greek myth Asclepius learned to restore the dead to life; Hades complained that the Underworld was being deprived of souls, and Zeus killed Asclepius with a thunderbolt. He was then placed among the stars holding a serpent, whose shedding of its skin made it a symbol of renewal and healing.","The two Arabic names identify corresponding parts of the combined figure: Rasalhague marks the head of the healer, while Unukalhai marks the neck of the serpent in his hands."],"source":"https://www.ianridpath.com/startales/ophiuchus.html","names":[{"name":"Rasalhague","wiki":"https://en.wikipedia.org/wiki/Alpha_Ophiuchi"},{"name":"Unukalhai","wiki":"https://en.wikipedia.org/wiki/Alpha_Serpentis"}]},{"group":"Names that map the picture","title":"The Deneb family","stars":"Deneb · Denebola · Deneb Algedi","key":"tail · Lion's Tail · Goat's Tail","paragraphs":["The Arabic root dhanab means 'tail' and occurs in several traditional star names. Deneb marks the tail of Cygnus, Denebola the tail of Leo, and Deneb Algedi the tail of Capricornus, the Sea-Goat. The names are descriptive phrases that later came to be treated as proper names.","The recurrence of Deneb reflects the use of anatomical labels in medieval Arabic stellar nomenclature. European catalogues later transmitted many of these positional descriptions as proper names.","Names derived from dhanab generally identify the tail of the constellation figure to which the star belonged."],"source":"https://en.wikipedia.org/wiki/Deneb","names":[{"name":"Deneb","wiki":"https://en.wikipedia.org/wiki/Deneb"},{"name":"Denebola","wiki":"https://en.wikipedia.org/wiki/Denebola"},{"name":"Deneb Algedi","wiki":"https://en.wikipedia.org/wiki/Delta_Capricorni"}]},{"group":"Names that map the picture","title":"Virgo's harvest","stars":"Spica · Vindemiatrix","key":"ear of grain · grape-gatherer","paragraphs":["Spica is Latin for an ear of grain, and traditional images of Virgo place the bright star in the stalk held in the Maiden's hand. The agricultural symbolism predates the classical Greek figure: part of the same region was the Babylonian Furrow, associated with the goddess Shala and an ear of grain. The modern star name continues an image attached to this part of the sky for more than two millennia.","Greek and Roman authors did not agree on a single identity for Virgo. One agricultural interpretation associated the Maiden with Demeter or Persephone. In the myth, Hades carried Persephone into the Underworld; her mother Demeter, goddess of grain and agriculture, withdrew her fertility from the earth while searching for her. A settlement eventually allowed Persephone to spend part of the year with her mother and part below, providing an ancient mythic explanation for the cycle of growth and barrenness.","Another tradition identified the Maiden with Dike or Astraea, the personification of justice. Later accounts said that Justice lived among humans in the Golden Age but withdrew as successive generations became more violent and corrupt, finally taking her place among the stars. In this interpretation Virgo and neighbouring Libra form the Maiden of Justice beside her scales.","Vindemiatrix has a different agricultural origin. Its Latin name means the grape-gatherer or vintager and reflects the use of its seasonal appearance as a marker associated with the grape harvest. It belongs to an observing calendar rather than to the anatomy of the Virgo figure.","Virgo consequently combines an old grain symbol, classical traditions concerning fertility and justice, and star names associated with the agricultural year."],"source":"https://en.wikipedia.org/wiki/Spica","names":[{"name":"Spica","wiki":"https://en.wikipedia.org/wiki/Spica"},{"name":"Vindemiatrix","wiki":"https://en.wikipedia.org/wiki/Vindemiatrix"}],"images":[{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/Early%20classical%20Attic%20white%20ground%20lekythos%20-%20ARV%20extra%20-%20Persephone%20and%20Demeter%20-%20Athens%20NAM%201754.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:Early_classical_Attic_white_ground_lekythos_-_ARV_extra_-_Persephone_and_Demeter_-_Athens_NAM_1754.jpg","alt":"Persephone and Demeter on an Attic white-ground lekythos, early Classical period","caption":"Persephone and Demeter — Attic white-ground lekythos, early Classical period"}]},{"group":"Names that map the picture","title":"Orion is almost an anatomical diagram","stars":"Betelgeuse · Rigel · Mintaka · Alnilam · Alnitak · Saiph · Meissa","key":"hand · foot · belt · string · girdle · sword","paragraphs":["Many familiar stars in Orion have Arabic names derived from positional descriptions. Rigel comes from rijl, 'foot'; Mintaka from a word for the belt or girdle; Alnitak also refers to the girdle; and Alnilam is connected with the ordered string or arrangement of the three Belt stars. These names entered European astronomy through the transmission of Arabic stellar traditions.","Betelgeuse has a more complicated manuscript history. Its ancestor referred to the hand of al-Jawzāʾ, consistent with the star's position in Orion's upper body, but centuries of copying and transliteration produced the modern spelling. Saiph descends from an Arabic phrase for the giant's sword, although the modern star lies near Orion's knee or lower leg rather than in the short line now usually called the Sword.","The name Meissa appears to have migrated to λ Orionis through confusion involving neighbouring Arabic lunar-mansion material. Orion's stellar names therefore record several stages of observation, translation, copying and reinterpretation rather than a single designed nomenclature.","The Greek Orion was a giant hunter, but ancient sources preserve several incompatible accounts of his life and death. In one version he boasted that he could kill every animal on Earth, and Gaia sent a scorpion that killed him. Zeus placed both hunter and scorpion in the sky. Their separation became part of the astronomical story, since Orion sets as Scorpius rises and the two do not dominate the night together.","Other traditions made Artemis responsible for Orion's death, sometimes accidentally after Apollo tricked her into shooting a distant target in the sea. A later astronomical version connected the story with Ophiuchus: Asclepius revived Orion, and Zeus subsequently killed the healer because of his power over death. These traditions linked constellations visible in different seasons as parts of the same mythological cycle."],"source":"https://xing.fmi.uni-jena.de/mediawiki/index.php/Meissa","names":[{"name":"Betelgeuse","wiki":"https://en.wikipedia.org/wiki/Betelgeuse"},{"name":"Rigel","wiki":"https://en.wikipedia.org/wiki/Rigel"},{"name":"Mintaka","wiki":"https://en.wikipedia.org/wiki/Mintaka"},{"name":"Alnilam","wiki":"https://en.wikipedia.org/wiki/Alnilam"},{"name":"Alnitak","wiki":"https://en.wikipedia.org/wiki/Alnitak"},{"name":"Saiph","wiki":"https://en.wikipedia.org/wiki/Saiph"},{"name":"Meissa","wiki":"https://en.wikipedia.org/wiki/Meissa"}],"images":[{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/Johannes%20Hevelius%20-%20Prodromus%20Astronomia%20-%20Volume%20III%20%22Firmamentum%20Sobiescianum%2C%20sive%20uranographia%22%20-%20Tavola%20QQ%20-%20Orion.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:Johannes_Hevelius_-_Prodromus_Astronomia_-_Volume_III_\"Firmamentum_Sobiescianum,_sive_uranographia\"_-_Tavola_QQ_-_Orion.jpg","alt":"Orion in Johannes Hevelius’s Firmamentum Sobiescianum, 1690","caption":"Orion — Hevelius, 1690"}]},{"group":"Names that map the picture","title":"Capella and the Kids","stars":"Capella · Haedus I · Haedus II","key":"little she-goat · the Kids","paragraphs":["Capella means 'little she-goat' in Latin. In traditional depictions of Auriga, the Charioteer carries a goat on his shoulder and two young goats, the Haedi, on his arm. Zeta and Eta Aurigae retain the Kids as Haedus I and Haedus II.","The goat was identified with Amalthea, who nourished the infant Zeus while he was hidden in Crete from his father Kronos. Kronos had swallowed Zeus's older siblings after being warned that one of his children would overthrow him. Rhea saved the newborn Zeus by giving Kronos a stone wrapped like an infant, while Zeus was concealed and raised in secret.","Later traditions connected Amalthea's horn with the cornucopia, the inexhaustible horn of plenty, and her hide with the aegis used by Zeus. The name Capella therefore connects the star with the myth of Zeus's childhood and the eventual overthrow of the Titans."],"source":"https://en.wikipedia.org/wiki/Capella","names":[{"name":"Capella","wiki":"https://en.wikipedia.org/wiki/Capella"},{"name":"Haedus I","wiki":"https://en.wikipedia.org/wiki/Zeta_Aurigae"},{"name":"Haedus II","wiki":"https://en.wikipedia.org/wiki/Eta_Aurigae"}],"images":[{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/Johannes%20Hevelius%20-%20Prodromus%20Astronomia%20-%20Volume%20III%20%22Firmamentum%20Sobiescianum%2C%20sive%20uranographia%22%20-%20Tavola%20X%20-%20Auriga.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:Johannes_Hevelius_-_Prodromus_Astronomia_-_Volume_III_%22Firmamentum_Sobiescianum,_sive_uranographia%22_-_Tavola_X_-_Auriga.jpg","alt":"Auriga carrying the goat and Kids — Hevelius, 1690","caption":"Auriga carrying the goat and Kids — Hevelius, 1690"}]},{"group":"Names that map the picture","title":"Castor & Pollux","stars":"α Geminorum · β Geminorum","key":"Dioscuri · mortal and immortal twins","paragraphs":["Castor and Pollux are the two bright stars associated with Gemini. Their names are the Latin forms of the Greek Dioscuri, Kastor and Polydeukes, heroic twins connected with horsemanship, athletics, seafaring and the protection of travellers.","Ancient accounts differ over their parentage. In the best-known later version, Pollux is a son of Zeus and is immortal, while Castor is the mortal son of Tyndareus. After Castor is killed, Pollux refuses an immortality that would separate him permanently from his brother. Zeus allows them to share Pollux's immortality, either by alternating between Olympus and the Underworld or by placing them together among the stars as Gemini.","Castor appears as a single bright star to the naked eye but is a hierarchical system of six stars arranged as three close binary pairs. The multiple system provides an accidental astronomical parallel to the constellation of the Twins.","Pollux is currently the brighter of the two stars despite carrying the Bayer letter beta, while Castor is alpha. Bayer letters were not assigned as a strict ranking by apparent brightness."],"source":"https://en.wikipedia.org/wiki/Castor_and_Pollux","names":[{"name":"Castor","wiki":"https://en.wikipedia.org/wiki/Castor_(star)"},{"name":"Pollux","wiki":"https://en.wikipedia.org/wiki/Pollux_(star)"}],"images":[{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/Castor%20and%20Pollux%2C%20archaic%20relief%2C%20AM%20of%20Delphi%2C%20201363.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:Castor_and_Pollux,_archaic_relief,_AM_of_Delphi,_201363.jpg","alt":"Castor and Pollux on an archaic Greek relief from Delphi, about 560 BC","caption":"Castor and Pollux — metope from the Treasury of Sicyon at Delphi, c. 560 BC"}]},{"group":"Names that map the picture","title":"Fomalhaut","stars":"α Piscis Austrini","key":"mouth of the Southern Fish","paragraphs":["Fomalhaut derives from Arabic fam al-ḥūt, 'mouth of the fish'. It lies at the mouth of Piscis Austrinus, the Southern Fish, in traditional constellation drawings.","Historical artwork also connects the star with Aquarius. The Water-Bearer pours a stream from his jar, and the stream terminates at the mouth of the Southern Fish. Greek astronomical lore described the Great Fish as receiving or swallowing the water of Aquarius, making Fomalhaut the point at which the two figures meet.","The connection also appeared in older cataloguing. Ptolemy treated Fomalhaut in a way that associated it with Aquarius as well as the Fish, and later cataloguers differed over its placement before modern constellation boundaries fixed it in Piscis Austrinus. The star name and the artwork retain this older connection between the two figures.","Historical atlases show the Water-Bearer's stream running directly into the Fish's mouth, so the meaning of the name Fomalhaut is visible in the drawing. Modern stick figures usually omit this interaction."],"source":"https://en.wikipedia.org/wiki/Fomalhaut","names":[{"name":"Fomalhaut","wiki":"https://en.wikipedia.org/wiki/Fomalhaut"}]},{"group":"Names that map the picture","title":"Cetus in fragments","stars":"Menkar · Baten Kaitos · Diphda · Mira","key":"nostril · belly · frog · wonderful","paragraphs":["Several naming traditions coexist in Cetus. Menkar is the sea monster's nostril and Baten Kaitos its belly, both Arabic positional names. Diphda descends from a 'frog' tradition, while Mira is Latin for 'wonderful' or 'astonishing', a name associated with the star's large variations in brightness.","The Greek figure behind Cetus belongs to the Perseus-Andromeda cycle. Cassiopeia boasted that she or her daughter Andromeda surpassed the sea nymphs in beauty; Poseidon sent a sea monster to ravage the kingdom, and Andromeda was chained to a rock as a sacrifice. Perseus encountered her after killing Medusa, slew the monster and rescued her.","The modern constellation consequently combines a Greek monster, Arabic anatomical names, a separate frog tradition and a Latin name for a variable star. These names were inherited from different astronomical and cultural contexts rather than from a single naming system."],"source":"https://en.wikipedia.org/wiki/Cetus","names":[{"name":"Menkar","wiki":"https://en.wikipedia.org/wiki/Alpha_Ceti"},{"name":"Baten Kaitos","wiki":"https://en.wikipedia.org/wiki/Zeta_Ceti"},{"name":"Diphda","wiki":"https://en.wikipedia.org/wiki/Beta_Ceti"},{"name":"Mira","wiki":"https://en.wikipedia.org/wiki/Mira"}],"images":[{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/Corinthian%20Vase%20depicting%20Perseus%2C%20Andromeda%20and%20Ketos.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:Corinthian_Vase_depicting_Perseus,_Andromeda_and_Ketos.jpg","alt":"Ancient Corinthian vase depicting Perseus, Andromeda and the sea monster Ketos","caption":"Perseus, Andromeda and Ketos — ancient Corinthian vase"}]},{"group":"Names that map the picture","title":"Vulpecula's missing goose","stars":"Anser · α Vulpeculae","key":"the Goose","paragraphs":["Johannes Hevelius introduced the figure in the seventeenth century as Vulpecula cum Ansere, 'the Little Fox with the Goose'. His atlas depicts the fox carrying the goose in its jaws and treats the two animals as a single scene.","Later usage shortened the constellation name to Vulpecula, removing the goose from the official title. The older figure remains in the name Anser, α Vulpeculae. The constellation name means 'fox' and the star name 'goose', retaining both parts of Hevelius's original picture."],"source":"https://en.wikipedia.org/wiki/Vulpecula","names":[{"name":"Anser","wiki":"https://en.wikipedia.org/wiki/Alpha_Vulpeculae"}]},{"group":"Names from watching the sky","title":"Alphard","stars":"α Hydrae","key":"the Solitary One","paragraphs":["Alphard derives from Arabic al-fard, 'the solitary one'. The name describes the visual appearance of the region rather than a body part or mythological object.","The second-magnitude star lies conspicuously alone in the long, sparse body of Hydra, with few comparably bright stars nearby. Its proper name originated as a description of the same appearance that remains visible to the naked eye."],"source":"https://en.wikipedia.org/wiki/Alphard","names":[{"name":"Alphard","wiki":"https://en.wikipedia.org/wiki/Alphard"}]},{"group":"Names from watching the sky","title":"Mira","stars":"ο Ceti","key":"the Wonderful Star","paragraphs":["Mira means 'wonderful' or 'astonishing' in Latin. Omicron Ceti is a long-period pulsating variable that can become readily visible to the naked eye near maximum and then fade far below naked-eye visibility.","David Fabricius first recorded the star's changing brightness in 1596 while using it as a reference during observations of Jupiter. It brightened and later disappeared from view, and was initially taken for a nova. Johannes Holwarda subsequently established that the variation repeated on a period of roughly eleven months.","Johannes Hevelius published Historiola Mirae Stellae in 1662 and established the name Mira, the Wonderful Star, for the object. A periodically disappearing star was difficult to reconcile with the traditional conception of the fixed stars as unchanging. Mira later gave its name to the class of Mira variables.","Mira is now understood as an evolved red giant whose outer layers expand and contract, producing large changes in luminosity. The historical name retains the reaction of early telescopic astronomy to its recurring disappearance and return."],"source":"https://en.wikipedia.org/wiki/Mira","names":[{"name":"Mira","wiki":"https://en.wikipedia.org/wiki/Mira"}]},{"group":"Names from watching the sky","title":"Arcturus","stars":"α Boötis","key":"guardian of the Bear","paragraphs":["Arcturus derives from Greek Arktouros, usually interpreted as the guardian or watcher of the Bear. The name reflects the arrangement of the northern sky: Boötes follows Ursa Major around the pole, and its brightest star became the Bear-Watcher.","One Greek tradition identified Boötes with Arcas, son of Zeus and Callisto. Callisto had been transformed into a bear. Years later Arcas encountered the bear while hunting and, not recognising his mother, pursued her. Zeus intervened and placed the two in the heavens as the Bear and her guardian.","This is one of several ancient identifications of Boötes. In it, the etymology of Arcturus, the relative positions of Boötes and Ursa Major, and the story of Arcas and Callisto refer to the same relationship between the two constellation figures."],"source":"https://www.ianridpath.com/startales/bootes.html","names":[{"name":"Arcturus","wiki":"https://en.wikipedia.org/wiki/Arcturus"}]},{"group":"Names from watching the sky","title":"Procyon","stars":"α Canis Minoris","key":"before the Dog","paragraphs":["Procyon is Greek for 'before the dog'. The dog is Sirius, the Dog Star in Canis Major. From many northern latitudes Procyon rises before Sirius, so the name records the order in which the two bright stars appear at the eastern horizon.","The name is observational rather than anatomical. Procyon is the principal star of Canis Minor, but its etymology refers to its rising before Sirius rather than to a part of the smaller dog figure."],"source":"https://en.wikipedia.org/wiki/Procyon","names":[{"name":"Procyon","wiki":"https://en.wikipedia.org/wiki/Procyon"}]},{"group":"Names from watching the sky","title":"Thuban","stars":"α Draconis","key":"a former Pole Star","paragraphs":["Thuban, α Draconis, was once much closer to the north celestial pole than Polaris is today. Because Earth's rotation axis slowly changes direction through precession, the pole lay close to Thuban during the third millennium BC.","Axial precession causes Earth's rotational axis to trace a slow circle among the stars over a cycle of roughly 26,000 years. The identity of the Pole Star is therefore temporary, with different stars lying nearest the pole at different epochs.","Thuban's name comes through Arabic and is associated with a serpent or dragon, consistent with its position in Draco. Its former proximity to the pole shows how different the geometry of the northern sky was in antiquity."],"source":"https://en.wikipedia.org/wiki/Thuban","names":[{"name":"Thuban","wiki":"https://en.wikipedia.org/wiki/Thuban"}]},{"group":"Names from watching the sky","title":"Aldebaran","stars":"α Tauri","key":"the Follower","paragraphs":["Aldebaran derives from Arabic al-dabarān, 'the Follower'. It follows the Pleiades as the celestial sphere turns, with the compact cluster crossing the sky before the bright orange star. The name records this observed sequence rather than Aldebaran's position in the Taurus figure.","In the Greek-derived picture of Taurus, Aldebaran instead forms the Bull's eye and appears to lie among the Hyades. It is actually much closer to Earth than the Hyades and is not a member of that cluster. The Hyades themselves carried mythology of their own: they were commonly imagined as sisters whose grief for Hyas caused their association with rain, and in other traditions they served as nurses of the infant Dionysus.","The Bull also became entangled with several Greek myths. The best-known identifies Taurus with Zeus after he transformed himself into a tame white bull to approach the Phoenician princess Europa. When Europa climbed onto the animal's back, Zeus carried her across the sea to Crete, where she became the mother of Minos, Rhadamanthys and Sarpedon. Another tradition associated the Bull with Io, whom Zeus transformed into a heifer, while still others connected it with the Cretan Bull encountered by Heracles.","Aldebaran belongs simultaneously to several inherited descriptions of the region: it is the Arabic Follower of the Pleiades, the eye of the celestial Bull, and a foreground star that appears among the mythological Hyades despite not belonging to the cluster physically."],"source":"https://en.wikipedia.org/wiki/Aldebaran","names":[{"name":"Aldebaran","wiki":"https://en.wikipedia.org/wiki/Aldebaran"}],"images":[{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/Europa%20copy.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:Europa_copy.jpg","alt":"Europa riding Zeus in the form of a bull, after an Attic red-figure vase of about 480 BC","caption":"Europa and the Bull — red-figure vase design, c. 480 BC"}]},{"group":"Names from watching the sky","title":"Antares","stars":"α Scorpii","key":"rival of Ares","paragraphs":["Antares is conventionally understood from Greek as anti-Ares, the rival or counterpart of Ares. Ares was the Greek god of the violent and destructive aspect of war, later identified by the Romans with Mars. The astronomical comparison is immediately visible: Antares is bright and distinctly reddish, while Mars is the conspicuous red planet.","Because Mars moves along the ecliptic, it can pass through the same general zodiacal region as Antares. Ancient observers could therefore compare the two red objects directly when they appeared near one another. The traditional name records a visual comparison that can still recur in the modern sky.","Antares also sits in the heart of Scorpius, the creature tied in Greek myth to the death of Orion. In one widespread account the boastful hunter threatened to kill every animal on Earth, and Gaia sent a scorpion against him. The two were subsequently placed on opposite sides of the heavens, so the red 'rival of Ares' occupies the centre of a constellation whose own mythology is about a lethal contest."],"source":"https://en.wikipedia.org/wiki/Antares","names":[{"name":"Antares","wiki":"https://en.wikipedia.org/wiki/Antares"}]},{"group":"Names from watching the sky","title":"Regulus","stars":"α Leonis","key":"little king","paragraphs":["Regulus is Latin for 'little king' or 'prince'. The name is medieval Latin, although the star had royal associations in several earlier astronomical traditions. Regulus lies at the base of Leo's Sickle, in the region traditionally interpreted as the Lion's heart or chest.","For the Greeks, Leo was commonly identified with the Nemean Lion, the monster killed in the first labour of Heracles. Its hide could not be pierced by ordinary weapons. Heracles first tried arrows and a sword, then trapped the lion in its cave and strangled it with his bare hands. He subsequently wore the skin as armour, using one of the animal's own claws to cut the otherwise impenetrable hide.","The lion's pelt became one of Heracles's principal attributes in ancient art. In the identification of Leo with the Nemean Lion, Regulus marks the body of the first monster killed in the cycle of the twelve labours."],"source":"https://en.wikipedia.org/wiki/Regulus","names":[{"name":"Regulus","wiki":"https://en.wikipedia.org/wiki/Regulus"}],"images":[{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/Heracles%20lion%20de%20Nemee%20vase%20figures%20noires%20-%20Musee%20Romanite.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:Heracles_lion_de_Nemee_vase_figures_noires_-_Musee_Romanite.jpg","alt":"Heracles wrestling the Nemean Lion on an Attic black-figure amphora","caption":"Heracles and the Nemean Lion — Attic black-figure amphora"}]},{"group":"Astronomical archaeology","title":"Libra's Scorpion claws","stars":"Zubenelgenubi · Zubeneschamali","key":"Southern Claw · Northern Claw","paragraphs":["Zubenelgenubi and Zubeneschamali mean the Southern Claw and Northern Claw. The names derive from an older Greek stellar tradition in which this region was the Chelae, the claws of Scorpius. Aratus repeatedly described the stars in this way, and Ptolemy retained the claw terminology in his catalogue.","The Balance developed as a distinct zodiacal figure and became established in Roman astronomy, while the older anatomy continued in stellar nomenclature. Arabic astronomers inherited the claw tradition, and European astronomy later inherited the Arabic names. The principal traditional names in modern Libra consequently still describe the former claws of neighbouring Scorpius.","Libra also acquired a second mythic connection through Virgo. In Roman and later classical imagery the scales could belong to Astraea or Dike, the Maiden of Justice represented by Virgo. Stories of Astraea described Justice as the last divine being to live openly among humans; as the ages deteriorated from the ideal Golden Age into violence and corruption, she finally withdrew to the heavens. Virgo and Libra could thus be read together as Justice and her balance.","The same stars therefore carry several historical interpretations: Babylonian and Greek claw imagery, Roman scales, Arabic claw-names, and the later association of Libra with the justice figure represented by Virgo."],"source":"https://xing.fmi.uni-jena.de/mediawiki/index.php/Zubeneschamali","names":[{"name":"Zubenelgenubi","wiki":"https://en.wikipedia.org/wiki/Alpha_Librae"},{"name":"Zubeneschamali","wiki":"https://en.wikipedia.org/wiki/Beta_Librae"}]},{"group":"Astronomical archaeology","title":"Alpheratz","stars":"α Andromedae · formerly also δ Pegasi","key":"Andromeda · Great Square of Pegasus","paragraphs":["Alpheratz is α Andromedae and also forms the north-eastern corner of the Great Square of Pegasus. Its double identity dates from a period before modern constellation boundaries assigned every star exclusively to one official region.","The star was historically shared between Andromeda and Pegasus and carried both α Andromedae and δ Pegasi in older Bayer usage. Its traditional Arabic-derived name is horse-related, retaining another connection with Pegasus. The modern IAU boundary places the star in Andromeda, while the Great Square still uses it as one of the four principal corners of Pegasus.","Andromeda herself belongs to one of the largest connected mythological scenes in the sky. Her mother Cassiopeia boasted that she or her daughter surpassed the Nereids in beauty, angering Poseidon. The god sent the sea monster Cetus to devastate the coast, and an oracle demanded Andromeda's sacrifice. She was chained to a rock until Perseus encountered her while returning from the slaying of Medusa, killed the monster and married her.","The neighbouring constellations contain much of the mythological cast: Cepheus, Cassiopeia, Andromeda, Perseus and Cetus, with Pegasus nearby. Alpheratz retains traces of both constellation traditions, being officially in Andromeda, visually part of the Great Square, and linguistically associated with the horse."],"source":"https://ase.exopla.net/index.php/Alpheratz","names":[{"name":"Alpheratz","wiki":"https://en.wikipedia.org/wiki/Alpheratz"}],"images":[{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/Perseus%20and%20Andromeda.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:Perseus_and_Andromeda.jpg","alt":"Perseus beside the chained Andromeda, with the head of Medusa; Roman fresco, AD 55–79","caption":"Perseus and Andromeda — Roman fresco, AD 55–79"}]},{"group":"Astronomical archaeology","title":"Algol","stars":"β Persei","key":"head of the ghoul","paragraphs":["Algol derives from Arabic raʾs al-ghūl, 'head of the ghoul' or demon. In the Perseus figure it marks the head of Medusa, which the hero carries after beheading the Gorgon.","Medusa was one of the three Gorgons and the only mortal one. In the best-known version Perseus could not look at her directly because her gaze turned observers to stone. Assisted by divine gifts, he approached using the reflection in Athena's polished shield, cut off Medusa's head and escaped her immortal sisters. The severed head retained its petrifying power and later became part of Athena's aegis.","Algol is also an eclipsing binary. Its apparent brightness falls markedly when the fainter component passes in front of the brighter star, so the star associated with Medusa's head periodically dims and recovers. The traditional name predates the modern explanation of eclipsing binaries, making the correspondence an astronomical coincidence."],"source":"https://en.wikipedia.org/wiki/Algol","names":[{"name":"Algol","wiki":"https://en.wikipedia.org/wiki/Algol"}],"images":[{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/Ancient%20greek%20terracotta%20with%20Perseus%20and%20Medusa.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:Ancient_greek_terracotta_with_Perseus_and_Medusa.jpg","alt":"Perseus holding the severed head of Medusa — Greek terracotta relief, c. 490–470 BC","caption":"Perseus holding the severed head of Medusa — Greek terracotta relief, c. 490–470 BC"}]},{"group":"Human fingerprints","title":"Kronos & Krios","stars":"HD 240430 · HD 240429","key":"possible planetary engulfment","paragraphs":["Kronos and Krios are a wide pair of Sun-like stars roughly 100 parsecs away. They move together through space and have similar estimated ages, so a common origin would normally imply nearly the same initial chemical composition.","Spectroscopy instead showed Kronos, HD 240430, to be about 0.2 dex richer in iron than Krios and particularly enhanced in refractory elements, which are abundant in rocky material; Kronos also contains substantially more lithium. A 2018 study proposed that Kronos had accreted roughly 15 Earth masses of rocky planetary material after the stars formed. Later high-precision work confirmed the large chemical difference and found planetary engulfment remained a plausible explanation, although the system's exact history is not uniquely determined.","The names were chosen for the mythology before they became official star names. Kronos was the youngest of the Titans, children of the primordial sky Uranus and earth Gaia. Uranus had imprisoned some of their children, and Gaia armed Kronos with a sickle; Kronos ambushed and overthrew his father and became ruler of the divine order that preceded Zeus. He was then warned that one of his own children would overthrow him in turn, so he swallowed Hestia, Demeter, Hera, Hades and Poseidon as soon as they were born. His wife Rhea saved the youngest, Zeus, by giving Kronos a stone wrapped in swaddling clothes. Zeus grew up in hiding, forced Kronos to disgorge his siblings and eventually defeated the Titans in the Titanomachy, establishing the Olympian generation of gods.","Krios was one of Kronos's Titan brothers and is much less individualised in surviving myth. Hesiod makes him the father of Astraeus, Pallas and Perses; through Astraeus, his descendants are connected with the stars and winds. The 2018 authors nicknamed the chemically unusual pair Kronos and Krios, choosing Kronos in reference to the proposed ingestion of rocky planetary material and the Titan's myth of swallowing his children. In April 2026 the IAU Working Group on Star Names adopted both names officially."],"source":"https://arxiv.org/abs/1709.05344","names":[{"name":"Kronos","wiki":"https://en.wikipedia.org/wiki/Cronus"},{"name":"Krios","wiki":"https://en.wikipedia.org/wiki/Crius"}],"images":[{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/Rhea%20handing%20a%20swaddled%20stone%20to%20Cronus%2C%20Attic%20terracotta%20pelike%2C%20c.%20460%E2%80%93450%20BC%2C%20Met%2006.1021.144.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:Rhea_handing_a_swaddled_stone_to_Cronus,_Attic_terracotta_pelike,_c._460%E2%80%93450_BC,_Met_06.1021.144.jpg","alt":"Rhea gives Kronos the swaddled stone in place of Zeus — Attic red-figure pelike, c. 460–450 BC","caption":"Rhea gives Kronos the swaddled stone in place of Zeus — Attic red-figure pelike, c. 460–450 BC"}]},{"group":"Astronomical archaeology","title":"Rasalgethi","stars":"α Herculis","key":"head of the Kneeler","paragraphs":["Rasalgethi, α Herculis, belongs to the same family of Arabic 'head' names as Rasalhague. Its first element is raʾs, head; the remainder refers to the old figure of Hercules as the Kneeler.","The same Arabic root also appears in Rasalhague. Rasalhague identifies the head of Ophiuchus and Rasalgethi the head of Hercules, so the element raʾs turns both proper names into positional descriptions."],"source":"https://en.wikipedia.org/wiki/Alpha_Herculis","names":[{"name":"Rasalgethi","wiki":"https://en.wikipedia.org/wiki/Alpha_Herculis"}]},{"group":"Human fingerprints","title":"Sualocin & Rotanev","stars":"α Delphini · β Delphini","key":"NICOLAUS · VENATOR, backwards","paragraphs":["Sualocin and Rotanev, α and β Delphini, are among the rare traditional star names whose puzzle can be solved simply by reading them backwards: SUALOCIN becomes NICOLAUS and ROTANEV becomes VENATOR.","Nicolaus Venator is the Latinised form of Niccolò Cacciatore—his Italian surname itself means 'hunter'. Cacciatore worked at Palermo Observatory as assistant to Giuseppe Piazzi and later succeeded him as director. The reversed names appeared in the Palermo star catalogue in the early nineteenth century, almost certainly as a concealed signature.","The concealed names entered long-term astronomical usage and were eventually standardised by the IAU. Sualocin and Rotanev are therefore official modern star names derived from Cacciatore's nineteenth-century wordplay."],"source":"https://xing.fmi.uni-jena.de/mediawiki/index.php/Sualocin","names":[{"name":"Sualocin","wiki":"https://en.wikipedia.org/wiki/Alpha_Delphini"},{"name":"Rotanev","wiki":"https://en.wikipedia.org/wiki/Beta_Delphini"}]},{"group":"Human fingerprints","title":"Cor Caroli","stars":"α Canum Venaticorum","key":"Heart of Charles","paragraphs":["Cor Caroli is Latin for 'Heart of Charles'. The name became attached to α Canum Venaticorum in connection with the English Stuart monarchy, but the exact Charles commemorated became confused: some accounts associate it with Charles I, others with Charles II and the Restoration.","The ambiguity reflects the way traditional star names were transmitted through atlases and later anecdotes before the existence of a central naming authority. The meaning 'Heart of Charles' remained stable, while the identification of the commemorated king became uncertain."],"source":"https://en.wikipedia.org/wiki/Cor_Caroli","names":[{"name":"Cor Caroli","wiki":"https://en.wikipedia.org/wiki/Cor_Caroli"}]},{"group":"Human fingerprints","title":"La Superba & Garnet Star","stars":"Y Canum Venaticorum · μ Cephei","key":"names from observed colour","paragraphs":["La Superba and Garnet Star arose from visual descriptions rather than mythology. Both are very red evolved stars whose colours attracted the attention of nineteenth-century observers and subsequently became part of their names.","Y Canum Venaticorum is a carbon star whose spectrum is dominated by carbon-bearing molecules that strongly suppress blue and violet light. Angelo Secchi described its Type IV spectrum as superba in 1868. Later historical work shows that John Birmingham turned that description into the proper name La Superba in the 1870s. The name means 'the Superb' or 'the Magnificent'.","Mu Cephei owes its name to William Herschel's description of the star as having a very deep garnet colour. Giuseppe Piazzi subsequently printed Garnet Sidus in his 1803 Palermo catalogue. WGSN adopted the concise form Garnet Star as the official name in 2024 after reviewing the historical alternatives attached to μ Cephei.","Both names retain the visual impressions of individual observers. They originated neither as mythological names nor as positional labels, but from descriptions of the stars' conspicuous colours."],"source":"https://ase.exopla.net/index.php/Garnet_Star","names":[{"name":"La Superba","wiki":"https://en.wikipedia.org/wiki/Y_Canum_Venaticorum"},{"name":"Garnet Star","wiki":"https://en.wikipedia.org/wiki/Mu_Cephei"}]},{"group":"Human fingerprints","title":"Blaze Star","stars":"T Coronae Borealis","key":"recurrent nova","paragraphs":["Blaze Star is the modern proper name of T Coronae Borealis, a recurrent nova normally far too faint for naked-eye observation. During an eruption, however, the system brightens by many magnitudes and temporarily inserts a conspicuous new point into the curve of Corona Borealis.","The system consists of a white dwarf accreting matter from a red-giant companion. When enough hydrogen accumulates on the white dwarf, a thermonuclear runaway occurs on its surface. The star itself is not destroyed, allowing the process to recur; well-observed eruptions occurred in 1866 and 1946.","The nickname is much older than the recent publicity surrounding the system. WGSN historical research traced 'Blaze Star' for T CrB to nineteenth-century usage following the 1866 eruption, including an 1869 account and later popularisation by Richard Proctor. The IAU adopted Blaze Star as the official proper name in 2025.","The proper name describes the system's recurrent behaviour. T Coronae Borealis is normally inconspicuous, but during an eruption it brightens dramatically and becomes visible to the naked eye."],"source":"https://ase.exopla.net/index.php/Blaze_Star","names":[{"name":"Blaze Star","wiki":"https://en.wikipedia.org/wiki/T_Coronae_Borealis"}]},{"group":"Human fingerprints","title":"Peacock & Avior","stars":"α Pavonis · ε Carinae","key":"twentieth-century navigational names","paragraphs":["Peacock and Avior are comparatively modern names despite their appearance alongside much older traditional names. Both entered use through the twentieth-century British Air Almanac project, when navigators required a practical set of named reference stars.","Alpha Pavonis was one of the navigational stars without a traditional proper name, so the Nautical Almanac Office simply called it Peacock after its constellation Pavo. Epsilon Carinae was the other conspicuous unnamed member of the set and received the newly coined name Avior.","Modern catalogues place Peacock and Avior beside names such as Aldebaran, Rigel and Antares even though their histories differ greatly. The navigational names were coined in the twentieth century, whereas many Arabic-derived names had already passed through centuries of astronomical transmission.","The IAU Working Group on Star Names approved Peacock and Avior for modern use in 2016. Their origin lies in the practical requirements of twentieth-century navigation rather than in ancient or medieval mythology."],"source":"https://xing.fmi.uni-jena.de/mediawiki/index.php/Avior","names":[{"name":"Peacock","wiki":"https://en.wikipedia.org/wiki/Alpha_Pavonis"},{"name":"Avior","wiki":"https://en.wikipedia.org/wiki/Epsilon_Carinae"}]},{"group":"Human fingerprints","title":"Camelopardalis & Kamelos","stars":"HIP 31940","key":"camel + leopard → giraffe","paragraphs":["Camelopardalis retains the old European word camelopard for the giraffe, based on the animal's perceived combination of a camel-like form and leopard-like spots. Petrus Plancius introduced the faint northern constellation in the early seventeenth century to fill a large region without a classical constellation figure.","In December 2025 the IAU Working Group on Star Names approved Kamelos for HIP 31940 in Camelopardalis. Kamelos is Greek for camel and was chosen in deliberate reference to the etymology of Camelopardalis.","Kamelos is therefore a modern reference to the older etymology of Camelopardalis. A seventeenth-century constellation name derived from the camelopard has supplied the basis for an official twenty-first-century star name."],"source":"https://xing.fmi.uni-jena.de/mediawiki/index.php/Kamelos","names":[{"name":"Kamelos","wiki":""}]},{"group":"Lost constellations returning as stars","title":"Quadrans","stars":"44 Boötis A","key":"from Quadrans Muralis","paragraphs":["Quadrans Muralis was Lalande's Mural Quadrant, a constellation introduced in 1795 between Boötes and Draco to commemorate the wall-mounted instrument used for precise positional measurements.","The Quadrantid meteor shower retained the obsolete constellation's name because its radiant lay in Quadrans Muralis when the shower was named. The modern shower consequently bears the name of a constellation absent from official maps.","In 2025 the IAU Working Group on Star Names approved Quadrans for 44 Boötis A, one of the principal stars of Lalande's former figure. The name now occurs in the history of the instrument, the lost constellation, the Quadrantid meteor shower and the modern star."],"source":"https://www.iau.org/IAU/IAU/News/Ann2026/New-Star-Names-2026.aspx","names":[{"name":"Quadrans","wiki":"https://en.wikipedia.org/wiki/44_Bo%C3%B6tis"}]},{"group":"Lost constellations returning as stars","title":"Rangifer & Tarandus","stars":"49 Cassiopeiae A · 2 Ursae Minoris","key":"from the lost Reindeer","paragraphs":["Rangifer and Tarandus are two modern star names derived from the former constellation of the Reindeer. Pierre Charles Le Monnier created the figure after taking part in Maupertuis's Lapland expedition, whose geodetic work helped establish that the Earth is oblate.","Reindeer were central to Sámi life, and Sámi sky lore also contains a much larger celestial reindeer, Sarvvis. Modern historical work has raised the possibility that Le Monnier's Rangifer was influenced by what the expedition encountered in Lapland rather than being selected simply as a generic northern animal.","In December 2025 the IAU approved Rangifer for 49 Cassiopeiae and Tarandus for 2 Ursae Minoris. The two names now represent the same obsolete constellation on separate stars."],"source":"https://xing.fmi.uni-jena.de/mediawiki/index.php/Tarandus","names":[{"name":"Rangifer","wiki":"https://en.wikipedia.org/wiki/49_Cassiopeiae"},{"name":"Tarandus","wiki":"https://en.wikipedia.org/wiki/2_Ursae_Minoris"}]},{"group":"Lost constellations returning as stars","title":"Aerostaticus","stars":"ε Microscopii","key":"from Globus Aerostaticus","paragraphs":["Aerostaticus is a 2026 IAU star name derived from Globus Aerostaticus, the former Hot-Air Balloon constellation. Lalande proposed the constellation in 1798 after the development of Montgolfier ballooning, and Bode included it in Uranographia. Its brightest star is now ε Microscopii.","Globus Aerostaticus belonged to an eighteenth-century change in European constellation design. In addition to inherited heroes, animals and mythological objects, mapmakers increasingly proposed the technologies of their own period. Balloons, telescopes, electrical machines and printing workshops were all represented in the same celestial atlases as Hercules and Andromeda.","Globus Aerostaticus was not retained among the 88 modern constellations. On 16 July 2026 WGSN adopted Aerostaticus for ε Microscopii, returning the name of the former balloon figure to one of its stars more than two centuries after its introduction."],"source":"https://exopla.net/star-names/modern-iau-star-names/","names":[{"name":"Aerostaticus","wiki":"https://en.wikipedia.org/wiki/Epsilon_Microscopii"}],"images":[{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/Sidney%20Hall%20-%20Urania%27s%20Mirror%20-%20Aquarius%2C%20Piscis%20Australis%20%26%20Ballon%20Aerostatique.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:Sidney_Hall_-_Urania's_Mirror_-_Aquarius,_Piscis_Australis_&_Ballon_Aerostatique.jpg","alt":"Globus Aerostaticus, the obsolete Hot-Air Balloon, in Urania's Mirror","caption":"Globus Aerostaticus — Urania's Mirror, 1825"}]},{"group":"Lost constellations returning as stars","title":"Protome","stars":"6 Equulei","key":"the ancient forepart of the Horse","paragraphs":["WGSN adopted Protome for 6 Equulei on 16 July 2026. The Ancient Greek word denotes a forepart, bust or head-and-shoulders figure and reflects the old conception of Equuleus specifically as the forepart of a horse.","The small constellation appears relatively late in the surviving Greek astronomical record. Geminos called it Protomē Hippou, the Forepart of the Horse, and Ptolemy included the figure in the Almagest. Its stars are faint and compact, and the precise reason for the constellation's creation is not preserved.","Later mythographers associated the little horse with several stories. One tradition identified it with Hippe, daughter of the centaur Chiron, who concealed her pregnancy from her father and was transformed into a mare. Other accounts made the figure a foal connected with neighbouring Pegasus. These identifications are later and less consistent than the astronomical description preserved in the word Protome.","The modern star name uses the older Greek description rather than the later Latin name Equuleus. It therefore retains the terminology used by ancient astronomers for the figure's partial horse shape."],"source":"https://ase.exopla.net/index.php/Equuleus","names":[{"name":"Protome","wiki":"https://en.wikipedia.org/wiki/Equuleus"}]},{"group":"Lost constellations returning as stars","title":"Alfarasalkamil","stars":"ο Andromedae","key":"the Complete Horse across Andromeda and Pegasus","paragraphs":["Alfarasalkamil means 'the Complete Horse'. WGSN adopted it for ο Andromedae in May 2025 from a historical horse figure described by al-Ṣūfī, whose stars extend across regions now assigned to Andromeda, Pegasus, Lacerta and Cygnus.","The figure differs from classical Pegasus, which is normally represented only by the front portion of a horse. Al-Ṣūfī described a complete horse in the surrounding sky. Medieval Islamic manuscripts could thus contain inherited Greco-Roman constellations alongside additional local or authorial figures drawn over many of the same stars.","Omicron Andromedae marks the snout of the reconstructed Complete Horse. Other stars assigned to the figure include parts of modern Pegasus and extend as far as Cygnus. Modern constellation boundaries hide this older animal because its body crosses several official territories.","Omicron Andromedae is officially in Andromeda but carries a name belonging to the Complete Horse. As with Alpheratz, the apparent mismatch records an older division and interpretation of the same stars rather than an error in modern nomenclature."],"source":"https://ase.exopla.net/index.php/Alfarasalkamil","names":[{"name":"Alfarasalkamil","wiki":"https://en.wikipedia.org/wiki/Omicron_Andromedae"}]},{"group":"Lost constellations returning as stars","title":"Sukhurmashu","stars":"α¹ Capricorni","key":"Mesopotamian Goat-Fish","paragraphs":["Sukhurmashu is the Akkadian name of the Goat-Fish, the ancient Mesopotamian creature associated with the region that became Capricornus. WGSN adopted the name for α¹ Capricorni on 16 July 2026.","The name records a much older stage in the history of Capricornus. Although the constellation is often encountered through Greek and Roman explanations, cuneiform star lists contain the Goat-Fish centuries before the classical constellation reached its familiar form.","In Mesopotamian tradition the goat-fish was a beneficent hybrid creature connected with the watery divine sphere of Enki or Ea. The combination of goat and fish therefore belonged to an established Near Eastern symbolic tradition from which the later zodiacal figure developed.","The modern name Sukhurmashu places this Mesopotamian ancestry alongside the later Greek and Roman traditions of Capricornus, retaining an older cuneiform layer of the zodiacal figure."],"source":"https://exopla.net/star-names/modern-iau-star-names/","names":[{"name":"Sukhurmashu","wiki":"https://en.wikipedia.org/wiki/Alpha_Capricorni"}]},{"group":"Lost constellations returning as stars","title":"Stellio & Rhombus","stars":"α Lacertae · α Reticuli","key":"older constellation names","paragraphs":["Stellio and Rhombus are modern star names derived from older names for their surrounding constellation figures. Both were adopted in 2024, although their historical origins are different.","Hevelius introduced modern Lacerta as Lacerta sive Stellio—'the Lizard or Stellion'. He explained that the gap between Andromeda and Cygnus was so narrow that no large animal could fit there, while a small spotted lizard suited both the available space and the scattered stars. Stellio, literally a kind of 'star lizard', was adopted for α Lacertae, so Hevelius's discarded alternative name remains inside the constellation he created.","Rhombus, now the name of α Reticuli, reaches back to an earlier geometric figure in the same southern region. Isaac Habrecht and later mapmakers used a constellation called Rhombus before Lacaille introduced his Réticule rhomboïde—the rhomboidal reticle—from which modern Reticulum developed. The modern constellation kept the reticle and lost the explicit rhombus; the star name restores it.","The names retain alternatives that disappeared when the modern 88 constellations were standardised. Stellio survives within Lacerta and Rhombus within Reticulum as official stellar names."],"source":"https://ase.exopla.net/index.php/Stellio","names":[{"name":"Stellio","wiki":"https://en.wikipedia.org/wiki/Alpha_Lacertae"},{"name":"Rhombus","wiki":"https://en.wikipedia.org/wiki/Alpha_Reticuli"}],"images":[{"src":"https://commons.wikimedia.org/wiki/Special:FilePath/Johannes%20Hevelius%20-%20Prodromus%20Astronomia%20-%20Volume%20III%20%22Firmamentum%20Sobiescianum%2C%20sive%20uranographia%22%20-%20Tavola%20M%20-%20Lacerta%20sive%20stellio.jpg?width=900","page":"https://commons.wikimedia.org/wiki/File:Johannes_Hevelius_-_Prodromus_Astronomia_-_Volume_III_%22Firmamentum_Sobiescianum,_sive_uranographia%22_-_Tavola_M_-_Lacerta_sive_stellio.jpg","alt":"Lacerta sive Stellio in Hevelius's Firmamentum Sobiescianum","caption":"Lacerta sive Stellio — Hevelius, 1690"}]},{"group":"A few Chinese skies","title":"Vega · Altair · Tianjinnan","stars":"Vega · Altair · ζ Cygni A","key":"Weaver Girl · Cowherd · Celestial Ferry","paragraphs":["In Chinese tradition Vega is associated with Zhīnǚ, the Weaver Girl, and Altair with Niúláng, the Cowherd. Their story is an enduring part of East Asian celestial folklore.","The lovers are separated by the Silver River—the Milky Way—after their union disrupts the order expected of them. They are allowed to meet only once each year, on the seventh night of the seventh lunar month, when a bridge of magpies is said to form across the river. The story underlies the Qixi festival in China and related festivals elsewhere in East Asia.","The celestial geography corresponds directly to the myth: Vega lies on one side of the Milky Way and Altair on the other, with the luminous band forming the Silver River that separates them.","In July 2026 WGSN adopted Tianjinnan as the official name of ζ Cygni A. The name means the southern star of Tianjin, the Celestial Ferry, an asterism in the Milky Way between the two lovers and traditionally associated with crossing the celestial river. The modern catalogue therefore includes another named point in the same celestial story."],"source":"https://exopla.net/star-names/modern-iau-star-names/","names":[{"name":"Vega","wiki":"https://en.wikipedia.org/wiki/Vega"},{"name":"Altair","wiki":"https://en.wikipedia.org/wiki/Altair"},{"name":"Tianjinnan","wiki":"https://en.wikipedia.org/wiki/Zeta_Cygni"}]},{"group":"A few Chinese skies","title":"Shēn — the Three Stars","stars":"Orion's Belt","key":"the Three Stars in Chinese astronomy","paragraphs":["The three stars of Orion's Belt belong in Chinese astronomy to Shēn, the Three Stars, one of the traditional lunar mansions. Chinese astronomy organised this part of the sky through an independent system of asterisms and celestial offices rather than as a single Greek hunter.","The three bright, evenly spaced Belt stars were prominent in both traditions, but the surrounding figures and stories differed. The same stellar pattern was incorporated into distinct cultural maps of the sky."],"source":"https://en.wikipedia.org/wiki/Three_Stars_(Chinese_constellation)","names":[{"name":"Alnitak","wiki":"https://en.wikipedia.org/wiki/Alnitak"},{"name":"Alnilam","wiki":"https://en.wikipedia.org/wiki/Alnilam"},{"name":"Mintaka","wiki":"https://en.wikipedia.org/wiki/Mintaka"}]},{"group":"A few Chinese skies","title":"Antares as the Heart","stars":"Antares · 心宿二","key":"middle star of Xīn, the Heart","paragraphs":["In traditional Chinese astronomy Antares is the middle star of Xīn, the Heart, and is known as the Second Star of Heart. Xīn was also one of the twenty-eight lunar mansions.","Antares also lies near the heart of Scorpius in the Greco-Roman constellation. Its brightness and deep red colour made it a conspicuous central star in both regions. Chinese and Greco-Roman astronomical traditions consequently assigned the same star a central anatomical role independently."],"source":"https://en.wikipedia.org/wiki/Antares","names":[{"name":"Antares","wiki":"https://en.wikipedia.org/wiki/Antares"}]}];
  ...
  const ANAL_EMMA_EARTH_ECCENTRICITY = 0.0167;
  const ANAL_EMMA_EARTH_TILT = 23.44;
  function analemmaWrapRadians(angle) {
    return ((angle + Math.PI) % (2 * Math.PI) + 2 * Math.PI) % (2 * Math.PI) - Math.PI;
  }
  function analemmaSolveKepler(meanAnomaly, eccentricity) {
    let E = meanAnomaly;
    for (let i = 0; i < 10; i++) {
  ...
  function analemmaSolar(day, eccentricity = ANAL_EMMA_EARTH_ECCENTRICITY, axialTilt = ANAL_EMMA_EARTH_TILT) {
    const e = Math.max(0, Math.min(0.2, Number(eccentricity)));
    const tilt = analemmaRad(((Number(axialTilt) % 360) + 360) % 360);
    const meanAnomaly = 2 * Math.PI * (day - 3) / 365;
    const eccentricAnomaly = analemmaSolveKepler(meanAnomaly, e);
    const trueAnomaly = 2 * Math.atan2(
      Math.sqrt(1 + e) * Math.sin(eccentricAnomaly / 2),
      Math.sqrt(1 - e) * Math.cos(eccentricAnomaly / 2)
    );
    const solarLongitudeAtPerihelion = analemmaRad(282.94);
    const apparentLongitude = trueAnomaly + solarLongitudeAtPerihelion;
    const meanLongitude = meanAnomaly + solarLongitudeAtPerihelion;
    const rightAscension = Math.atan2(
      Math.cos(tilt) * Math.sin(apparentLongitude),
      Math.cos(apparentLongitude)
    );
    const dec = Math.asin(Math.max(-1, Math.min(1, Math.sin(tilt) * Math.sin(apparentLongitude))));
    const eot = analemmaDeg(analemmaWrapRadians(meanLongitude - rightAscension)) * 4;
    return { eot, dec };
  }
  function analemmaDayForSolarLongitude(longitudeDeg, eccentricity) {
    const e = Math.max(0, Math.min(0.2, Number(eccentricity)));
    const solarLongitudeAtPerihelion = analemmaRad(282.94);
    const trueAnomaly = analemmaWrapRadians(analemmaRad(longitudeDeg) - solarLongitudeAtPerihelion);
    const eccentricAnomaly = 2 * Math.atan2(
      Math.sqrt(1 - e) * Math.sin(trueAnomaly / 2),
      Math.sqrt(1 + e) * Math.cos(trueAnomaly / 2)
    );
    const meanAnomaly = ((eccentricAnomaly - e * Math.sin(eccentricAnomaly)) % (2 * Math.PI) + 2 * Math.PI) % (2 * Math.PI);
    let day = 3 + meanAnomaly / (2 * Math.PI) * 365;
    if (day > 365) day -= 365;
    if (day < 1) day += 365;
    return day;
  }
  function analemmaSeasonMarkers(eccentricity) {
    return [
      [analemmaDayForSolarLongitude(0, eccentricity), 'Mar', 'Mar eqx'],
      [analemmaDayForSolarLongitude(90, eccentricity), 'Jun', 'Jun sol'],
      [analemmaDayForSolarLongitude(180, eccentricity), 'Sep', 'Sep eqx'],
      [analemmaDayForSolarLongitude(270, eccentricity), 'Dec', 'Dec sol']
    ];
  }
  function analemmaAltAz(latDeg, timeHours, day, eccentricity = ANAL_EMMA_EARTH_ECCENTRICITY, axialTilt = ANAL_EMMA_EARTH_TILT) {
    const s = analemmaSolar(day, eccentricity, axialTilt);
  ...
  function miscEntryImages(entry, className) {
    const images = Array.isArray(entry.images) && entry.images.length
      ? entry.images
      : (entry.image ? [{ src: entry.image, page: entry.imagePage || entry.image, alt: entry.imageAlt || entry.name || entry.title, caption: entry.imageCaption || '' }] : []);
    if (!images.length) return '';
    return `<div class="${className}">${images.map(image => {
      const src = image.src || '';
      const zoom = src.replace(/([?&])width=\d+/, '$1width=1800');
      return `<div class="misc-entry-image-item">
        <button type="button" class="former-image-link misc-image-button" data-misc-zoom="${esc(zoom)}" data-misc-zoom-alt="${esc(image.alt || entry.name || entry.title || '')}">
          <img class="former-image" src="${esc(src)}" alt="${esc(image.alt || entry.name || entry.title || '')}" loading="lazy" decoding="async">
        </button>
        ${image.caption ? `<div class="misc-entry-image-caption">${esc(image.caption)}</div>` : ''}
        ${image.page ? `<a class="former-image-source" href="${esc(image.page)}" target="_blank" rel="noopener noreferrer">Commons ↗</a>` : ''}
      </div>`;
    }).join('')}</div>`;
  }
  ...
  function renderFormerConstellations() {
    ...
    function renderList() {
      ...
      const filtered = q ? FORMER_CONSTELLATIONS.filter(entry => {
        const haystack = norm([entry.name, entry.meaning, entry.creator, entry.date, entry.position, entry.note || '', ...(entry.paragraphs || [])].join(' '));
      ...
      list.innerHTML = filtered.map(entry => {
        ...
        const sourceLink = entry.source && entry.source !== entry.wiki
          ...
          : '';
        const noteParagraphs = entry.paragraphs || (entry.note ? [entry.note] : []);
        const image = miscEntryImages(entry, 'former-image-wrap');
        return `<article class="former-entry${image ? ' has-image' : ''}">
          <div class="former-copy">
            ...
            ${noteParagraphs.map((paragraph, index) => `<p>${esc(paragraph)}${index === noteParagraphs.length - 1 ? sourceLink : ''}</p>`).join('')}
          </div>
          ${image}
        </article>`;
      }).join('');
      ...
      list.querySelectorAll('.former-image').forEach(img => img.addEventListener('error', () => {
        ...
        const item = img.closest('.misc-entry-image-item');
        const wrap = img.closest('.former-image-wrap');
        if (item) item.remove();
        if (wrap && !wrap.querySelector('.misc-entry-image-item')) wrap.remove();
        if (entry && !entry.querySelector('.former-image-wrap')) entry.classList.remove('has-image');
      }, { once: true }));
      wireMiscImageZoom();
    }
    ...
    function renderList() {
      ...
      list.innerHTML = filtered.map(entry => {
        ...
        const starLine = entry.stars && norm(entry.stars) !== norm(nameText)
          ...
          : '';
        const image = miscEntryImages(entry, 'star-story-images');
        return `<article class="star-story-entry${image ? ' has-image' : ''}">
  ...
  function renderAnalemma() {
    ...
    const state = states.analemma || (states.analemma = {
      ...
      showBelow: false,
      labels: true,
      eccentricity: ANAL_EMMA_EARTH_ECCENTRICITY,
      axialTilt: ANAL_EMMA_EARTH_TILT,
      timer: null
    });
    if (!Number.isFinite(state.eccentricity)) state.eccentricity = ANAL_EMMA_EARTH_ECCENTRICITY;
    if (!Number.isFinite(state.axialTilt)) state.axialTilt = ANAL_EMMA_EARTH_TILT;
    ...
    app.innerHTML = `<div class="controls misc-back-controls"><button type="button" id="miscBack">← Misc</button></div>
      ...
      <div class="analemma-layout">
        ...
        <div class="analemma-main">
          ...
          <section class="panel analemma-orbit-controls">
            <div class="analemma-orbit-field">
              <div class="analemma-orbit-label"><label for="analemmaEccentricity">Eccentricity</label><span id="analemmaEccentricityValue"></span></div>
              <input id="analemmaEccentricity" class="analemma-orbit-range" type="range" min="0" max="0.2" step="0.0001" value="${state.eccentricity}">
            </div>
            <div class="analemma-orbit-field">
              <div class="analemma-orbit-label"><label for="analemmaAxialTilt">Axial tilt</label><span id="analemmaAxialTiltValue"></span></div>
              <input id="analemmaAxialTilt" class="analemma-orbit-range" type="range" min="0" max="360" step="0.01" value="${state.axialTilt}">
            </div>
            <button type="button" id="analemmaEarth">Earth</button>
          </section>
        </div>
      </div>`;
    ...
    const eccentricitySlider = $('#analemmaEccentricity');
    const axialTiltSlider = $('#analemmaAxialTilt');
    ...
    function setEccentricity(value) {
      const n = Math.max(0, Math.min(0.2, Number(value)));
      if (!Number.isFinite(n)) return;
      state.eccentricity = n;
      eccentricitySlider.value = String(n);
      draw();
    }
    function setAxialTilt(value) {
      const n = Math.max(0, Math.min(360, Number(value)));
      if (!Number.isFinite(n)) return;
      state.axialTilt = n;
      axialTiltSlider.value = String(n);
      draw();
    }
    ...
    function drawHorizon(now) {
      ...
      const ana = [];
      for (let d = 1; d <= 365; d++) ana.push(analemmaAltAz(state.lat, state.time, d, state.eccentricity, state.axialTilt));
      drawHorizonLine(ana, '#111', 4);
      if (state.dailyPath) {
        const daily = [];
        for (let t = 0; t <= 24; t += 0.04) daily.push(analemmaAltAz(state.lat, t, state.day, state.eccentricity, state.axialTilt));
        drawHorizonLine(daily, '#777', 2, [8, 7]);
      }
      if (state.labels) {
        hctx.font = '13px Arial'; hctx.textAlign = 'left'; hctx.textBaseline = 'middle';
        for (const [d, label] of analemmaSeasonMarkers(state.eccentricity).map(([day, shortLabel]) => [day, shortLabel])) {
          const p = analemmaAltAz(state.lat, state.time, d, state.eccentricity, state.axialTilt);
          if (p.alt >= 0) {
            const q = horizonPoint(p.az, p.alt);
    ...
    function draw() {
      const now = analemmaAltAz(state.lat, state.time, state.day, state.eccentricity, state.axialTilt);
      ...
      $('#analemmaEccentricityValue').textContent = state.eccentricity.toFixed(4);
      $('#analemmaAxialTiltValue').textContent = `${state.axialTilt.toFixed(2)}°`;
      ...
      if (state.dailyPath) {
        ...
        for (let t = 0; t <= 24; t += 0.05) {
          const p = analemmaAltAz(state.lat, t, state.day, state.eccentricity, state.axialTilt);
      ...
      if (state.labels) {
        ...
        for (const [d, label] of analemmaSeasonMarkers(state.eccentricity).map(([day, , longLabel]) => [day, longLabel])) {
          const p = analemmaAltAz(state.lat, state.time, d, state.eccentricity, state.axialTilt);
    ...
    eccentricitySlider.addEventListener('input', () => setEccentricity(eccentricitySlider.value));
    axialTiltSlider.addEventListener('input', () => setAxialTilt(axialTiltSlider.value));
    $('#analemmaEarth').addEventListener('click', () => {
      state.eccentricity = ANAL_EMMA_EARTH_ECCENTRICITY;
      state.axialTilt = ANAL_EMMA_EARTH_TILT;
      eccentricitySlider.value = String(state.eccentricity);
      axialTiltSlider.value = String(state.axialTilt);
      draw();
    });
    ...
    $('#analemmaReset').addEventListener('click', () => {
      ...
      state.eccentricity = ANAL_EMMA_EARTH_ECCENTRICITY; state.axialTilt = ANAL_EMMA_EARTH_TILT;
      renderAnalemma();
    });
    $('#miscBack').addEventListener('click', () => {
      if (state.timer) clearInterval(state.timer);
