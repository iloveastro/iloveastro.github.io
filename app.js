(() => {
  ...
  const INTERESTING_STAR_STORIES = [{"group":"Names that map the picture","title":"Rasalhague & Unukalhai","stars":"α Ophiuchi · α Serpentis","key":"head of the Serpent Bearer · neck of the Serpent","paragraphs":["Rasalhague comes from Arabic for the head of the serpent-bearer, and α Ophiuchi sits at Ophiuchus's head. Nearby Unukalhai, α Serpentis, is the Serpent's Neck.","Together they turn the sprawling Ophiuchus–Serpens figure into something readable: the man's head beside the neck of the serpent he is holding."],"source":"https://en.wikipedia.org/wiki/Alpha_Ophiuchi"},{"group":"Names that map the picture","title":"The Deneb family","stars":"Deneb · Denebola · Deneb Algedi","key":"tail · Lion's Tail · Goat's Tail","paragraphs":["Arabic dhanab means tail. Deneb is the tail of the Swan, Denebola the tail of Leo, and Deneb Algedi the tail of the Goat.","Once the root is visible, three apparently unrelated proper names become pieces of the same old anatomical vocabulary."],"source":"https://en.wikipedia.org/wiki/Deneb"},{"group":"Names that map the picture","title":"Virgo's harvest","stars":"Spica · Vindemiatrix","key":"ear of grain · grape-gatherer","paragraphs":["Spica is Latin for an ear of grain, exactly what Virgo holds in traditional artwork. Vindemiatrix is the grape-gatherer: its seasonal appearance became associated with the vintage.","Virgo therefore preserves agriculture twice—one name from the picture in her hand, another from the calendar of harvesting."],"source":"https://en.wikipedia.org/wiki/Spica"},{"group":"Names that map the picture","title":"Orion is almost an anatomical diagram","stars":"Betelgeuse · Rigel · Mintaka · Alnilam · Alnitak · Saiph · Meissa","key":"hand · foot · belt · string · girdle · sword","paragraphs":["Rigel is the foot; Mintaka and Alnitak are belt/girdle names; Alnilam evokes the ordered string of the Belt. Betelgeuse descends from an Arabic 'hand of al-Jawza' expression, attached in Europe to Orion's upper body.","Saiph descends from a phrase for the giant's sword even though the modern star lies down near Orion's lower body. Meissa is stranger still: its name seems to have migrated to λ Orionis after historical confusion with neighbouring Gemini material. The names are not a designed system—they are manuscript fossils."],"source":"https://xing.fmi.uni-jena.de/mediawiki/index.php/Meissa"},{"group":"Names that map the picture","title":"Capella and the Kids","stars":"Capella · Haedus I · Haedus II","key":"little she-goat · the Kids","paragraphs":["Capella literally means little she-goat. Traditional Auriga artwork shows the Charioteer carrying the goat Amalthea on his shoulder, with the Haedi—the Kids—beside her.","Without the old picture, a goat inside the Charioteer seems arbitrary. With it, the names fall into place."],"source":"https://en.wikipedia.org/wiki/Capella"},{"group":"Names that map the picture","title":"Fomalhaut","stars":"α Piscis Austrini","key":"mouth of the Southern Fish","paragraphs":["Fomalhaut comes from Arabic for the mouth of the fish, and it lies at the mouth of Piscis Austrinus.","Old artwork makes the placement even better: the stream from Aquarius runs directly into that mouth. Fomalhaut is where two constellation pictures meet."],"source":"https://en.wikipedia.org/wiki/Fomalhaut"},{"group":"Names that map the picture","title":"Cetus in fragments","stars":"Menkar · Baten Kaitos · Diphda · Mira","key":"nostril · belly · frog · wonderful","paragraphs":["Menkar marks the sea monster's nostril and Baten Kaitos its belly. Diphda comes from a different 'frog' tradition, while Mira is Latin for wonderful or astonishing.","Cetus is a good reminder that neighbouring star names need not come from one coherent picture: several languages and sky traditions can be layered over the same modern constellation."],"source":"https://en.wikipedia.org/wiki/Cetus"},{"group":"Names that map the picture","title":"Vulpecula's missing goose","stars":"Anser · α Vulpeculae","key":"the Goose","paragraphs":["Hevelius introduced the constellation as Vulpecula cum Ansere—the Little Fox with the Goose—and drew the fox carrying a goose in its jaws.","The official constellation was shortened to Vulpecula, but the goose survived as the name Anser. The vanished picture is still encoded in the surviving constellation and star names."],"source":"https://en.wikipedia.org/wiki/Vulpecula"},{"group":"Names from watching the sky","title":"Alphard","stars":"α Hydrae","key":"the Solitary One","paragraphs":["Arabic al-fard means the solitary one. Alphard sits conspicuously alone in a broad, relatively empty-looking part of the sky.","It is less a mythological label than an observing note that has survived for centuries."],"source":"https://en.wikipedia.org/wiki/Alphard"},{"group":"Names from watching the sky","title":"Arcturus","stars":"α Boötis","key":"guardian of the Bear","paragraphs":["Greek Arktouros combines the bear with a guardian or watcher. Boötes follows Ursa Major around the northern sky, so his brightest star is the Bear-Watcher.","The name makes most sense when the northern constellations are read as one scene rather than as separate stick figures."],"source":"https://en.wikipedia.org/wiki/Arcturus"},{"group":"Names from watching the sky","title":"Procyon","stars":"α Canis Minoris","key":"before the Dog","paragraphs":["Greek pro kyon means before the dog. At many northern latitudes Procyon rises before Sirius, the Dog Star.","The name records an actual sequence in the night sky: watch the eastern horizon and the little dog announces the greater one."],"source":"https://en.wikipedia.org/wiki/Procyon"},{"group":"Names from watching the sky","title":"Aldebaran","stars":"α Tauri","key":"the Follower","paragraphs":["Arabic al-dabaran means the Follower. Aldebaran follows the Pleiades across the sky.","The same star is also the eye of Taurus in the Greco-Roman picture. One physical star therefore preserves two completely different ways of reading the same sky."],"source":"https://en.wikipedia.org/wiki/Aldebaran"},{"group":"Names from watching the sky","title":"Antares","stars":"α Scorpii","key":"rival of Ares","paragraphs":["Antares is conventionally read from Greek as the rival or counterpart of Ares—Mars.","The comparison is easy to reproduce: Antares is conspicuously red, Mars is conspicuously red, and Mars sometimes passes through the same zodiacal neighbourhood."],"source":"https://en.wikipedia.org/wiki/Antares"},{"group":"Names from watching the sky","title":"Regulus","stars":"α Leonis","key":"little king","paragraphs":["Regulus is Latin for little king or prince. The star sits at the base of Leo's Sickle and carries a royal tradition much older than the Latin name itself.","It is a useful contrast with the many Arabic anatomical names nearby: not every familiar proper name reached us through the same linguistic route."],"source":"https://en.wikipedia.org/wiki/Regulus"},{"group":"Astronomical archaeology","title":"Libra's Scorpion claws","stars":"Zubenelgenubi · Zubeneschamali","key":"Southern Claw · Northern Claw","paragraphs":["Libra is the Scales, yet its two great traditional names mean the Southern and Northern Claws. The mismatch is the point.","These stars belonged conceptually to the claws of a much larger Scorpius before Libra became firmly established as a separate balance. Modern Libra therefore carries older Scorpion anatomy in its star names."],"source":"https://xing.fmi.uni-jena.de/mediawiki/index.php/Zubeneschamali"},{"group":"Astronomical archaeology","title":"Alpheratz","stars":"α Andromedae · formerly also δ Pegasi","key":"Andromeda star, Pegasus fossil","paragraphs":["Alpheratz is officially α Andromedae but forms the north-eastern corner of the Great Square of Pegasus. Older cataloguing traditions treated the star as shared between the two figures, and it even carried δ Pegasi alongside α Andromedae.","Its traditional name is horse-related. The star's modern constellation, asterism membership and old name preserve three different boundary systems at once."],"source":"https://ase.exopla.net/index.php/Alpheratz"},{"group":"Astronomical archaeology","title":"Algol","stars":"β Persei","key":"head of the ghoul","paragraphs":["Algol descends from Arabic for the head of the ghoul or demon. In the Perseus picture it sits in the severed head of Medusa.","It is also an eclipsing binary whose brightness visibly drops. The sinister name did not arise from modern binary theory, but the coincidence is perfect: Medusa's eye really does fade and return."],"source":"https://en.wikipedia.org/wiki/Algol"},{"group":"Astronomical archaeology","title":"Rasalgethi","stars":"α Herculis","key":"head of the Kneeler","paragraphs":["Rasalgethi is another readable Arabic head-name: ras, head, plus the old description of Hercules as the Kneeler.","After learning Rasalhague and Rasalgethi, ras stops looking like meaningless syllables and becomes a reusable piece of stellar vocabulary."],"source":"https://en.wikipedia.org/wiki/Alpha_Herculis"},{"group":"Human fingerprints","title":"Sualocin & Rotanev","stars":"α Delphini · β Delphini","key":"NICOLAUS · VENATOR, backwards","paragraphs":["Reverse SUALOCIN and ROTANEV and you get NICOLAUS VENATOR.","That is the Latinised name of Niccolò Cacciatore, assistant and later successor to Giuseppe Piazzi at Palermo. The backwards names appeared in the Palermo catalogue and somehow endured; both are now official IAU star names. It is difficult to find a better reminder that astronomical nomenclature was made by actual people."],"source":"https://xing.fmi.uni-jena.de/mediawiki/index.php/Sualocin"},{"group":"Human fingerprints","title":"Cor Caroli","stars":"α Canum Venaticorum","key":"Heart of Charles","paragraphs":["Cor Caroli is straightforward Latin: Heart of Charles. The exact historical association with Charles I versus Charles II became muddled in later retellings.","That ambiguity is part of the charm: even a famous star name can preserve layers of political memory, later reinterpretation and imperfect historical transmission."],"source":"https://en.wikipedia.org/wiki/Cor_Caroli"},{"group":"Human fingerprints","title":"Peacock","stars":"α Pavonis","key":"a modern practical name","paragraphs":["Peacock is not an ancient inheritance. The English name was coined in the twentieth century for practical navigational use and later became the official IAU name of α Pavonis.","So Pavo means Peacock, and its brightest star is simply Peacock—a remarkably modern story beside names that have travelled through Arabic manuscripts for a millennium."],"source":"https://en.wikipedia.org/wiki/Alpha_Pavonis"},{"group":"Human fingerprints","title":"Camelopardalis & Kamelos","stars":"HIP 31940","key":"camel + leopard → giraffe","paragraphs":["Camelopardalis comes from the old camel-leopard idea of a giraffe: camel-like in shape, leopard-like in spots. Plancius introduced the faint northern constellation in 1612.","In December 2025 the IAU named a star at the figure's heart Kamelos, Greek for camel—a new name deliberately playing with the constellation's centuries-old etymology."],"source":"https://xing.fmi.uni-jena.de/mediawiki/index.php/Kamelos"},{"group":"Lost constellations returning as stars","title":"Quadrans","stars":"44 Boötis A","key":"Quadrans Muralis remembered","paragraphs":["Quadrans Muralis, Lalande's Mural Quadrant, disappeared from the official constellation map. Its ghost survived in the Quadrantid meteor shower, whose radiant lay in the lost figure.","In February 2025 the IAU officially named 44 Boötis A Quadrans. A constellation created in 1795, abolished by standardisation, and remembered by a meteor shower now has a named-star memorial too."],"source":"https://www.iau.org/IAU/IAU/News/Ann2026/New-Star-Names-2026.aspx"},{"group":"Lost constellations returning as stars","title":"Rangifer & Tarandus","stars":"49 Cassiopeiae A · 2 Ursae Minoris","key":"the lost Reindeer, twice","paragraphs":["Le Monnier introduced Rangifer, the Reindeer, after his Lapland years; later atlases also used the name Tarandus. The constellation disappeared.","In December 2025 the IAU adopted both Rangifer and Tarandus as separate official star names. A faint obsolete constellation now survives twice in the modern catalogue."],"source":"https://xing.fmi.uni-jena.de/mediawiki/index.php/Tarandus"},{"group":"A few Chinese skies","title":"Vega & Altair","stars":"Vega · Altair","key":"Weaver Girl · Cowherd","paragraphs":["In the Chinese story, the Weaver Girl Zhīnǚ and Cowherd Niúláng are separated by the celestial river—the Milky Way—and reunited on the seventh night of the seventh lunar month.","The geography is visible without a chart: Vega on one side of the Milky Way, Altair on the other. The story is still celebrated through Qixi and related East Asian traditions."],"source":"https://en.wikipedia.org/wiki/The_Cowherd_and_the_Weaver_Girl"},{"group":"A few Chinese skies","title":"Shēn — the Three Stars","stars":"Orion's Belt","key":"a different Orion","paragraphs":["Chinese astronomy did not inherit one Greek hunter called Orion. The unmistakable Belt belongs to Shēn, the Three Stars, a major traditional asterism and lunar mansion.","The same three evenly spaced stars became central structures in unrelated sky traditions—one of the clearest places to compare how different cultures partitioned the identical sky."],"source":"https://en.wikipedia.org/wiki/Three_Stars_(Chinese_constellation)"},{"group":"A few Chinese skies","title":"Antares as the Heart","stars":"Antares · 心宿二","key":"middle star of Xīn, the Heart","paragraphs":["In traditional Chinese astronomy Antares is the central star of Xīn, the Heart, and is known as the Second Star of Heart.","Western Scorpius also places the same brilliant red star near the creature's heart. Two different traditions independently gave an unusually conspicuous red star a central anatomical role."],"source":"https://en.wikipedia.org/wiki/Antares"}];
      ...
      list.innerHTML = filtered.map(entry => {
        ...
        const image = entry.image
          ? `<div class="former-image-wrap">
               <a class="former-image-link" href="${esc(entry.imagePage || entry.image)}" target="_blank" rel="noopener noreferrer" tabindex="-1">
  ...
  function renderInterestingStars() {
    ...
    app.innerHTML = `<div class="controls misc-back-controls"><button type="button" id="miscBack">← Misc</button></div>
      ...
      <div id="starStoryList" class="star-story-list"></div>`;
    ...
    function renderList() {
      ...
      let currentGroup = '';
      list.innerHTML = filtered.map(entry => {
        const heading = entry.group !== currentGroup
          ? `<h3 class="star-story-group">${esc(entry.group)}</h3>`
          : '';
        ...
        const sourceLink = entry.source
          ...
          : '';
        return `${heading}<article class="star-story-entry">
          <h4>${esc(entry.title)}</h4>
          ${entry.stars ? `<div class="star-story-stars">${esc(entry.stars)}</div>` : ''}
